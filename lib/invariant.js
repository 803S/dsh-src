/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-src`: every
 * src write must honor the exploration discipline — records carry the
 ...
 * @module @lihua_dis/dsh-src/invariant
 */
const PACKAGE_NAME = '@lihua_dis/dsh-src';
const DOMAIN_NAME = 'src';
...
export const name = 'dsh-src-invariant';
/** Service required before the companion can reserve package ownership. */
export const inject = ['invariants'];
/** Install the exploration-graph checks against the open src domain. */

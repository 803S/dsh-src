...
const VALID = Object.freeze({
	...
	DSH_SRC_LAYA_NEXT: ["off", "shadow", "on"]
});
...
const DEFAULTS = Object.freeze({
	...
	DSH_SRC_LAYA_SKILL: "on",
	DSH_SRC_LAYA_NEXT: "on"
});

function readFlag(name) {
	const raw = String(process.env[name] ?? "").trim().toLowerCase();
	return (raw !== "" && VALID[name].includes(raw)) ? raw : DEFAULTS[name];
}
...
export const srcLayaNextFlag = () => readFlag("DSH_SRC_LAYA_NEXT");

...
export function computeSuggestions({ intents = [], checkpoints = [], pendingApprovals = [], userTodos = [], now = Date.now() } = {}) {
	const raw = [];
	...
	// 5. finalize：全部 intent 终态且无 pending 审批/待办 → engagement 级完成建议

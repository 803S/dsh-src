window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		/** [local.9] Infrastructure setting keys shown in the 基础设施 tab, with zh labels/placeholders. */
		const INFRA_FIELDS = [
			["proxyUrl", "HTTP 代理", "http://127.0.0.1:7890（留空=直连）"],
			["burpMcpPort", "Burp MCP 端口", "9876"],
			["burpProxyJarPath", "mcp-proxy.jar 路径", "/path/to/mcp-proxy.jar"],
			["testAccount", "越权对照账号（低权）", "用于 A/B 水平越权对照的普通账号"],
			["testPhone", "短信测试手机号", "13800138000（仅限授权测试）"],
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { className: SrcView_module_css_default.list, children: [
				...
				todos.map((todo) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { className: SrcView_module_css_default.card, style: { borderLeft: `3px solid ${todo.status === "done" ? "#3c9" : todo.status === "abandoned" ? "#999" : "#e80"}`, marginBottom: 4, padding: "6px 10px", fontSize: 13 }, children: [
					...
					todo.status === "pending" && runCommand !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { style: { marginTop: 4 }, children: [
						noteFor?.id === todo.id ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(react_jsx_runtime.Fragment, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { style: { display: "flex", gap: 6, alignItems: "center", marginTop: 2 }, children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", { autoFocus: true, value: noteText, placeholder: `备注���可选）——${noteFor.status === "done" ? "如：已登录并抓好包" : "如：暂不测短信，跳过"}`, onChange: (event) => setNoteText(event.target.value), onKeyDown: (event) => { if (event.key === "Enter") void sendTodoFeedback(todo.id, noteFor.status, noteText); if (event.key === "Escape") setNoteFor(null); }, style: { flex: 1, minWidth: 160, fontSize: 12, padding: "4px 8px", borderRadius: 6, border: "1px solid rgba(127,127,127,.45)", background: "transparent", color: "inherit" } }),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", { type: "button", disabled: busyId !== null, onClick: () => void sendTodoFeedback(todo.id, noteFor.status, noteText), style: buttonStyle(noteFor.status === "done" ? "#3c9" : "#999"), children: "发送" }),
		...
		function InfraView({ src, t, runCommand }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { className: SrcView_module_css_default.list, children: [
				...
				/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("details", { style: { marginTop: 10, fontSize: 12 }, children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("summary", { style: { cursor: "pointer", color: "#888" }, children: "Burp MCP 接线示例（写入 profile 的 cordis.patch.yml）" }),

...
const getNodesBounds = (nodes, params = { nodeOrigin: [0, 0] }) => {
	if ("production" === "development" && !params.nodeLookup) console.warn("Please use `getNodesBounds` from `useReactFlow`/`useSvelteFlow` hook to ensure correct values for sub flows. If not possible, you have to provide a nodeLookup to support sub flows.");
...
const createDevWarn = (lib, helpUrl) => (id, message) => {
	if ("production" === "development") console.warn(`[${lib}]: ${message} Help: ${helpUrl}error#${id}`);
};
...
var require_shim = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	if ("production" === "production") module.exports = require_use_sync_external_store_shim_production();
...
var require_with_selector = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	if ("production" === "production") module.exports = require_with_selector_production();
...
const link = `https://reactflow.dev${"production" === "production" ? "?utm_source=attribution" : "/attribution"}`;
...
function useNodeOrEdgeTypesWarning(nodeOrEdgeTypes = emptyTypes) {
	const typesRef = (0, react.useRef)(nodeOrEdgeTypes);
	const store = useStoreApi();
	(0, react.useEffect)(() => {
...
function useStylesLoadedWarning() {
	const store = useStoreApi();
	const checked = (0, react.useRef)(false);
	(0, react.useEffect)(() => {
		if ("production" === "development") {
			if (!checked.current) {
...
*
*/
const NodeResizeControl = (0, react.memo)(ResizeControl);

//#endregion
//#region \0dsh-raw-css:/Users/lihua-dis/Software/dsh-src/src/dsh-client-ui-src/node_modules/@xyflow/react/dist/style.css.mjs
...
* @param projection - the standing pentest projection.
...
function layoutExploration(projection) {
	...
	return {
		nodes: stackByDepth([{
			...
			target: "target" in node ? node.target : void 0,
			confidence: "confidence" in node ? node.confidence : void 0,
			impact: "impact" in node ? node.impact : void 0,
			remediation: "remediation" in node ? node.remediation : void 0,
			pocEvidence: "pocEvidence" in node ? node.pocEvidence : void 0
		}))], depth, 320, 152),
		edges
	};
}
...
//#endregion
//#region \0dsh-css-module:/Users/lihua-dis/Software/dsh-src/src/dsh-client-ui-src/src/client/GraphDetailDrawer.module.css.mjs
const css$5 = ".jigtVh4f_layer {\n  z-index: 10;\n  position: absolute;\n  inset: 0;\n}\n\n.jigtVh4f_backdrop {\n  cursor: default;\n  backdrop-filter: blur(2px);\n  background: #0000003d;\n  border: 0;\n  width: 100%;\n  position: absolute;\n  inset: 0;\n}\n\n.jigtVh4f_drawer {\n  border-left: 1px solid color-mix(in oklab,var(--dsw-alias-border-l1) 60%,transparent);\n  background: color-mix(in oklab,var(--dsw-alias-bg-base) 78%,transparent);\n  backdrop-filter: blur(24px) saturate(1.4);\n  flex-direction: column;\n  width: min(400px, 88%);\n  display: flex;\n  position: absolute;\n  top: 0;\n  bottom: 0;\n  right: 0;\n  box-shadow: -24px 0 48px -24px #00000024, inset -1px 0 #ffffff0d;\n}\n\n.jigtVh4f_header {\n  border-bottom: 1px solid var(--dsw-alias-border-l2);\n  align-items: flex-start;\n  gap: 12px;\n  padding: 16px;\n  display: flex;\n}\n\n.jigtVh4f_title {\n  overflow-wrap: anywhere;\n  min-width: 0;\n  color: var(--dsw-alias-label-primary);\n  flex: auto;\n  margin: 0;\n  font-size: 15px;\n  line-height: 22px;\n}\n\n.jigtVh4f_close {\n  width: 28px;\n  height: 28px;\n  color: var(--dsw-alias-label-secondary);\n  cursor: pointer;\n  background: none;\n  border: 0;\n  border-radius: 4px;\n  flex: none;\n  padding: 0;\n  font-size: 22px;\n  line-height: 28px;\n}\n\n.jigtVh4f_close:hover, .jigtVh4f_close:focus-visible {\n  background: var(--dsw-alias-bg-layer-2);\n  outline: none;\n}\n\n.jigtVh4f_fields {\n  flex-direction: column;\n  gap: 14px;\n  margin: 0;\n  padding: 16px;\n  display: flex;\n  overflow-y: auto;\n}\n\n.jigtVh4f_field {\n  flex-direction: column;\n  gap: 4px;\n  display: flex;\n}\n\n.jigtVh4f_field dt {\n  color: var(--dsw-alias-label-tertiary);\n  font-size: 12px;\n  line-height: 18px;\n}\n\n.jigtVh4f_field dd {\n  overflow-wrap: anywhere;\n  color: var(--dsw-alias-label-primary);\n  margin: 0;\n  font-size: 13px;\n  line-height: 20px;\n}\n";
...
var GraphDetailDrawer_module_css_default = {
	"field": "jigtVh4f_field",
	"fields": "jigtVh4f_fields",
	"layer": "jigtVh4f_layer",
	"close": "jigtVh4f_close",
	"title": "jigtVh4f_title",
	"drawer": "jigtVh4f_drawer",
	"backdrop": "jigtVh4f_backdrop",
	"header": "jigtVh4f_header"
};
...
//#endregion
//#region \0dsh-css-module:/Users/lihua-dis/Software/dsh-src/src/dsh-client-ui-src/src/client/ExploreView.module.css.mjs
const css$4 = ".x7E0QRBB_graph {\n  border: 1px solid color-mix(in oklab,var(--dsw-alias-border-l2) 65%,transparent);\n  background: color-mix(in oklab,var(--dsw-alias-bg-base) 60%, transparent);\n  border-radius: 18px;\n  flex: auto;\n  min-height: 340px;\n  position: relative;\n  overflow: hidden;\n}\n\n.x7E0QRBB_graph:before {\n  content: \"\";\n  background: radial-gradient(1000px 600px at 20% -10%, var(--dsw-alias-brand-primary) 2%, transparent 40%),\n    radial-gradient(800px 500px at 85% 90%, var(--dsw-alias-state-business-primary) 1%, transparent 45%),\n    linear-gradient(135deg,var(--dsw-alias-bg-base) 60%,transparent);\n  opacity: .03;\n  pointer-events: none;\n  z-index: 1;\n  position: absolute;\n  inset: 0;\n}\n\n.x7E0QRBB_graph:after {\n  content: \"\";\n  background-image: radial-gradient(circle 1px, color-mix(in oklab,var(--dsw-alias-border-l2) 50%,transparent) 1%, transparent 100%);\n  opacity: .15;\n  pointer-events: none;\n  z-index: 1;\n  background-size: 16px 16px;\n  position: absolute;\n  inset: 0;\n}\n\n.x7E0QRBB_graph .react-flow__controls {\n  border: 1px solid color-mix(in oklab,var(--dsw-alias-border-l2) 70%,transparent);\n  background: color-mix(in oklab,var(--dsw-alias-bg-layer-1) 82%,transparent);\n  backdrop-filter: blur(8px);\n  border-radius: 8px;\n  overflow: hidden;\n  box-shadow: 0 4px 12px -4px #00000014;\n}\n\n.x7E0QRBB_graph .react-flow__controls-button {\n  border-bottom-color: var(--dsw-alias-border-l2);\n  background: color-mix(in oklab,var(--dsw-alias-bg-layer-1) 82%,transparent);\n  color: var(--dsw-alias-label-secondary);\n  transition: background .13s, color .13s;\n}\n\n.x7E0QRBB_graph .react-flow__controls-button:hover {\n  background: color-mix(in oklab,var(--dsw-alias-bg-layer-2) 65%,transparent);\n  color: var(--dsw-alias-label-primary);\n}\n\n.x7E0QRBB_graph .react-flow__controls-button svg {\n  fill: currentColor;\n}\n\n.x7E0QRBB_empty {\n  box-sizing: border-box;\n  text-align: center;\n  height: 100%;\n  color: var(--dsw-alias-label-caption);\n  place-items: center;\n  padding: 24px;\n  font-size: 13px;\n  line-height: 20px;\n  display: grid;\n}\n\n.x7E0QRBB_node {\n  box-sizing: border-box;\n  border: 1px solid color-mix(in oklab,var(--dsw-alias-border-l2) 60%,transparent);\n  background: color-mix(in oklab,var(--dsw-alias-bg-layer-1) 62%,transparent);\n  backdrop-filter: blur(8px) saturate(1.1);\n  cursor: pointer;\n  border-radius: 14px;\n  flex-direction: column;\n  gap: 6px;\n  width: 244px;\n  height: 128px;\n  padding: 12px 14px;\n  font-size: 12px;\n  line-height: 18px;\n  transition: box-shadow .2s, border-color .2s, transform .15s ease-out;\n  display: flex;\n  overflow: hidden;\n  box-shadow: 0 1px 2px #00000008, 0 12px 24px -12px #00000014, inset 0 0 0 1px #ffffff05;\n}\n\n.x7E0QRBB_node:hover {\n  border-color: color-mix(in oklab,var(--dsw-alias-border-l1) 85%,transparent);\n  transform: translateY(-2px);\n  box-shadow: 0 6px 16px -6px #0000001a, 0 20px 32px -16px #00000024, inset 0 0 0 1px #ffffff0a;\n}\n\n.x7E0QRBB_node[data-kind=\"goal\"] {\n  border-color: color-mix(in oklab,var(--dsw-alias-brand-primary) 40%,transparent);\n  background: color-mix(in oklab,var(--dsw-alias-brand-primary) 5%,var(--dsw-alias-bg-layer-2));\n  box-shadow: 0 4px 14px -6px #0000000f, 0 0 0 3px color-mix(in oklab,var(--dsw-alias-brand-primary) 12%,transparent), 0 0 20px -6px var(--dsw-alias-brand-primary);\n}\n\n.x7E0QRBB_handle {\n  border: 1px solid var(--dsw-alias-border-l2);\n  background: var(--dsw-alias-bg-layer-2);\n  border-radius: 999px;\n  width: 8px;\n  height: 8px;\n}\n\n.x7E0QRBB_edgeLabel {\n  border: 1px solid var(--dsw-alias-border-l2);\n  background: var(--dsw-alias-bg-layer-2);\n  color: var(--dsw-alias-label-secondary);\n  pointer-events: none;\n  white-space: nowrap;\n  border-radius: 999px;\n  padding: 2px 8px;\n  font-size: 11px;\n  line-height: 16px;\n  position: absolute;\n}\n\n.x7E0QRBB_badge {\n  background: var(--dsw-alias-bg-layer-2);\n  color: var(--dsw-alias-label-secondary);\n  border-radius: 999px;\n  align-self: flex-start;\n  padding: 0 8px;\n  font-size: 11px;\n  line-height: 18px;\n}\n\n.x7E0QRBB_node[data-kind=\"goal\"] .x7E0QRBB_badge {\n  color: var(--dsw-alias-brand-primary);\n  background: var(--dsw-alias-state-business-tertiary);\n}\n\n.x7E0QRBB_node[data-kind=\"fact\"] .x7E0QRBB_badge {\n  color: var(--dsw-alias-state-business-primary);\n  background: var(--dsw-alias-state-business-tertiary);\n}\n\n.x7E0QRBB_node[data-kind=\"finding\"] .x7E0QRBB_badge {\n  color: var(--dsw-alias-state-warn-primary);\n  background: var(--dsw-alias-state-warn-tertiary);\n}\n\n.x7E0QRBB_title {\n  min-width: 0;\n  color: var(--dsw-alias-label-primary);\n  text-overflow: ellipsis;\n  white-space: nowrap;\n  font-weight: 600;\n  overflow: hidden;\n}\n\n.x7E0QRBB_detail {\n  min-width: 0;\n  color: var(--dsw-alias-label-tertiary);\n  -webkit-line-clamp: 2;\n  -webkit-box-orient: vertical;\n  display: -webkit-box;\n  overflow: hidden;\n}\n\n.x7E0QRBB_severity {\n  background: var(--dsw-alias-bg-layer-2);\n  color: var(--dsw-alias-label-secondary);\n  border-radius: 999px;\n  align-self: flex-start;\n  padding: 0 8px;\n  font-size: 11px;\n  line-height: 18px;\n}\n\n.x7E0QRBB_severity[data-severity=\"critical\"], .x7E0QRBB_severity[data-severity=\"high\"] {\n  color: #fff;\n  background: var(--dsw-alias-state-error-primary);\n}\n\n.x7E0QRBB_severity[data-severity=\"medium\"] {\n  color: #fff;\n  background: var(--dsw-alias-state-warn-primary);\n}\n\n.x7E0QRBB_notesPanel {\n  background: color-mix(in oklab,var(--dsw-alias-bg-layer-2) 72%,transparent);\n  backdrop-filter: blur(16px) saturate(1.2);\n  border: 1px solid color-mix(in oklab,var(--dsw-alias-border-l1) 70%,transparent);\n  z-index: 6;\n  border-radius: 14px;\n  flex-direction: column;\n  width: 280px;\n  max-height: calc(100% - 24px);\n  font-size: 12px;\n  transition: all .2s;\n  display: flex;\n  position: absolute;\n  top: 12px;\n  right: 12px;\n  overflow: hidden;\n  box-shadow: 0 8px 32px -8px #0000001f, inset 0 0 0 1px #ffffff0a;\n}\n\n.x7E0QRBB_notesPanelClosed {\n  max-height: none;\n}\n\n.x7E0QRBB_notesHeader {\n  width: 100%;\n  color: var(--dsw-alias-label-primary);\n  cursor: pointer;\n  background: none;\n  border: none;\n  justify-content: space-between;\n  align-items: center;\n  padding: 8px 10px;\n  font-size: 12px;\n  font-weight: 600;\n  display: flex;\n}\n\n.x7E0QRBB_notesToggle {\n  color: var(--dsw-alias-label-tertiary);\n  font-size: 10px;\n}\n\n.x7E0QRBB_notesList {\n  border-top: 1px solid var(--dsw-alias-border-l2);\n  overflow-y: auto;\n}\n\n.x7E0QRBB_notesEmpty {\n  color: var(--dsw-alias-label-tertiary);\n  margin: 0;\n  padding: 10px 12px;\n  line-height: 1.6;\n}\n\n.x7E0QRBB_noteItem {\n  border-bottom: 1px solid var(--dsw-alias-border-l2);\n  padding: 8px 10px;\n}\n\n.x7E0QRBB_noteItem:last-child {\n  border-bottom: none;\n}\n\n.x7E0QRBB_noteTitle {\n  text-align: left;\n  width: 100%;\n  color: var(--dsw-alias-label-primary);\n  cursor: pointer;\n  word-break: break-word;\n  background: none;\n  border: none;\n  padding: 0;\n  font-size: 12px;\n  font-weight: 500;\n  line-height: 1.5;\n  display: block;\n}\n\n.x7E0QRBB_noteCategory {\n  background: var(--dsw-alias-bg-layer-1);\n  color: var(--dsw-alias-label-secondary);\n  vertical-align: 1px;\n  border-radius: 999px;\n  margin-right: 6px;\n  padding: 1px 6px;\n  font-size: 10.5px;\n  font-weight: 500;\n  display: inline-block;\n}\n\n.x7E0QRBB_noteContent {\n  white-space: pre-wrap;\n  color: var(--dsw-alias-label-secondary);\n  background: var(--dsw-alias-bg-layer-1);\n  border-radius: 6px;\n  margin: 6px 0 0;\n  padding: 6px 8px;\n  font-size: 11.5px;\n  line-height: 1.6;\n}\n\n.x7E0QRBB_noteMeta {\n  color: var(--dsw-alias-label-tertiary);\n  margin: 4px 0 0;\n  font-size: 10.5px;\n}\n";
const tagId$4 = "@lihua_dis/dsh-src/ui-src/ExploreView.module.css";
...
var ExploreView_module_css_default = {
	"empty": "x7E0QRBB_empty",
	"notesToggle": "x7E0QRBB_notesToggle",
	"notesPanelClosed": "x7E0QRBB_notesPanelClosed",
	"notesList": "x7E0QRBB_notesList",
	"noteCategory": "x7E0QRBB_noteCategory",
	"noteMeta": "x7E0QRBB_noteMeta",
	"node": "x7E0QRBB_node",
	"title": "x7E0QRBB_title",
	"detail": "x7E0QRBB_detail",
	"badge": "x7E0QRBB_badge",
	"noteTitle": "x7E0QRBB_noteTitle",
	"noteItem": "x7E0QRBB_noteItem",
	"noteContent": "x7E0QRBB_noteContent",
	"graph": "x7E0QRBB_graph",
	"severity": "x7E0QRBB_severity",
	"notesPanel": "x7E0QRBB_notesPanel",
	"handle": "x7E0QRBB_handle",
	"notesEmpty": "x7E0QRBB_notesEmpty",
	"edgeLabel": "x7E0QRBB_edgeLabel",
	"notesHeader": "x7E0QRBB_notesHeader"
};
...
function ExploreView({ src, t }) {
	...
	const [notesOpen, setNotesOpen] = (0, react.useState)(true);
	const [expandedNoteId, setExpandedNoteId] = (0, react.useState)(null);
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [
			nodes.length <= 1 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("aside", {
				className: `${ExploreView_module_css_default.notesPanel}${notesOpen ? "" : ` ${ExploreView_module_css_default.notesPanelClosed}`}`,
				"data-testid": "src-domain-notes",
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					type: "button",
					className: ExploreView_module_css_default.notesHeader,
					onClick: () => {
						setNotesOpen(!notesOpen);
					},
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: `📚 域笔记${notes.length > 0 ? ` · ${notes.length}` : ""}` }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						className: ExploreView_module_css_default.notesToggle,
						"aria-hidden": true,
						children: notesOpen ? "▾" : "▸"
					})]
				}), notesOpen && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					className: ExploreView_module_css_default.notesList,
					children: notes.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						className: ExploreView_module_css_default.notesEmpty,
						children: "本目标暂无域笔记——agent 沉淀（src_record_domain_note）后跨会话可见，开局也会自动带出。"
					}) : notes.map((note) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: ExploreView_module_css_default.noteItem,
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
								type: "button",
								className: ExploreView_module_css_default.noteTitle,
								onClick: () => {
									setExpandedNoteId(expandedNoteId === note.id ? null : note.id);
								},
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									className: ExploreView_module_css_default.noteCategory,
									children: NOTE_CATEGORY_LABELS[note.category] ?? note.category
								}), note.title]
							}),
							expandedNoteId === note.id && note.content !== "" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
								className: ExploreView_module_css_default.noteContent,
								children: note.content
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
								className: ExploreView_module_css_default.noteMeta,
								children: `来自会话 ${note.sourceSessionId === "" ? "—" : note.sourceSessionId.length > 14 ? `${note.sourceSessionId.slice(0, 14)}…` : note.sourceSessionId} · ${note.updatedAt > 0 ? new Date(note.updatedAt).toISOString().slice(0, 10) : "—"}`
							})
						]
					}, note.id))
				})]
...
//#endregion
//#region \0dsh-css-module:/Users/lihua-dis/Software/dsh-src/src/dsh-client-ui-src/src/client/FindingsView.module.css.mjs
const css$3 = ".IK6fT3Qh_list {\n  flex-direction: column;\n  gap: 10px;\n  margin: 0;\n  padding: 0;\n  list-style: none;\n  display: flex;\n}\n\n.IK6fT3Qh_finding {\n  border: 1px solid color-mix(in oklab,var(--dsw-alias-border-l2) 60%,transparent);\n  background: color-mix(in oklab,var(--dsw-alias-bg-layer-1) 55%,transparent);\n  backdrop-filter: blur(16px) saturate(1.15);\n  border-radius: 16px;\n  flex-direction: column;\n  gap: 10px;\n  min-width: 0;\n  padding: 16px 18px;\n  transition: all .2s;\n  display: flex;\n  box-shadow: 0 1px 2px #00000008, 0 4px 12px -4px #0000000a, inset 0 0 0 1px #ffffff05, inset 0 -2px 8px -4px #0000000f;\n}\n\n.IK6fT3Qh_finding:hover {\n  border-color: color-mix(in oklab,var(--dsw-alias-border-l1) 85%,transparent);\n  box-shadow: 0 8px 16px -6px #00000014, 0 24px 40px -12px #0000000d, inset 0 0 0 2px #ffffff0f;\n}\n\n.IK6fT3Qh_header {\n  align-items: center;\n  gap: 10px;\n  min-width: 0;\n  display: flex;\n}\n\n.IK6fT3Qh_severity {\n  background: var(--dsw-alias-bg-layer-2);\n  letter-spacing: .06em;\n  color: var(--dsw-alias-label-secondary);\n  text-transform: uppercase;\n  border-radius: 999px;\n  flex: none;\n  padding: 4px 14px;\n  font-size: 11.5px;\n  font-weight: 600;\n  line-height: 20px;\n  position: relative;\n  overflow: hidden;\n}\n\n.IK6fT3Qh_severity:before {\n  content: \"\";\n  opacity: 0;\n  pointer-events: none;\n  background: currentColor;\n  position: absolute;\n  inset: 0;\n}\n\n.IK6fT3Qh_severity:after {\n  content: \"\";\n  border-radius: inherit;\n  opacity: .3;\n  pointer-events: none;\n  background: linear-gradient(135deg, #0000 0%, #ffffff59 40%, #0000 100%);\n  position: absolute;\n  inset: 0;\n}\n\n.IK6fT3Qh_severity[data-severity=\"critical\"], .IK6fT3Qh_severity[data-severity=\"high\"] {\n  color: #fff;\n  background: linear-gradient(135deg, var(--dsw-alias-state-error-primary), color-mix(in srgb,var(--dsw-alias-state-error-primary) 78%, black));\n  font-weight: 650;\n  box-shadow: 0 2px 8px -2px #dc26264d, inset 0 1px #ffffff47;\n}\n\n.IK6fT3Qh_severity[data-severity=\"medium\"] {\n  color: #fff;\n  background: linear-gradient(135deg, var(--dsw-alias-state-warn-primary), color-mix(in srgb,var(--dsw-alias-state-warn-primary) 78%, black));\n  box-shadow: 0 2px 6px -2px #925b0033, inset 0 1px #ffffff42;\n}\n\n.IK6fT3Qh_severity[data-severity=\"low\"] {\n  color: #fff;\n  background: linear-gradient(135deg, var(--dsw-alias-state-business-primary), color-mix(in srgb,var(--dsw-alias-state-business-primary) 80%, black));\n  box-shadow: 0 2px 6px -2px #0032962e;\n}\n\n.IK6fT3Qh_severity[data-severity=\"info\"] {\n  color: #fff;\n  background: color-mix(in srgb,var(--dsw-alias-state-business-primary) 80%,transparent);\n}\n\n.IK6fT3Qh_title {\n  min-width: 0;\n  color: var(--dsw-alias-label-primary);\n  overflow-wrap: anywhere;\n  flex: auto;\n  margin: 0;\n  font-size: 14px;\n  font-weight: 600;\n  line-height: 22px;\n}\n\n.IK6fT3Qh_id {\n  color: var(--dsw-alias-label-caption);\n  flex: none;\n  font-size: 11px;\n  line-height: 20px;\n}\n\n.IK6fT3Qh_description {\n  color: var(--dsw-alias-label-secondary);\n  overflow-wrap: anywhere;\n  margin: 0;\n  font-size: 13px;\n  line-height: 20px;\n}\n\n.IK6fT3Qh_stepsBlock {\n  border: 1px solid var(--dsw-alias-border-l2);\n  background: var(--dsw-alias-bg-base);\n  border-radius: 8px;\n  flex-direction: column;\n  gap: 4px;\n  padding: 8px 10px;\n  display: flex;\n}\n\n.IK6fT3Qh_stepsLabel {\n  color: var(--dsw-alias-label-tertiary);\n  font-size: 11px;\n  font-weight: 600;\n  line-height: 18px;\n}\n\n.IK6fT3Qh_steps {\n  color: var(--dsw-alias-label-secondary);\n  overflow-wrap: anywhere;\n  flex-direction: column;\n  gap: 2px;\n  margin: 0;\n  padding-left: 20px;\n  font-size: 13px;\n  line-height: 20px;\n  display: flex;\n}\n\n.IK6fT3Qh_asset {\n  color: var(--dsw-alias-label-tertiary);\n  margin: 0;\n  font-size: 12px;\n  line-height: 20px;\n}\n\n.IK6fT3Qh_empty {\n  text-align: center;\n  color: var(--dsw-alias-label-caption);\n  margin: 0;\n  padding: 24px 0;\n  font-size: 13px;\n  line-height: 20px;\n}\n\n.IK6fT3Qh_fold {\n  border: 1px solid color-mix(in oklab,var(--dsw-alias-border-l2) 70%,transparent);\n  background: color-mix(in oklab,var(--dsw-alias-bg-base) 80%,transparent);\n  backdrop-filter: blur(4px);\n  border-radius: 8px;\n  padding: 8px 12px;\n  transition: border-color .13s;\n}\n\n.IK6fT3Qh_fold:hover {\n  border-color: color-mix(in oklab,var(--dsw-alias-border-l1) 80%,transparent);\n}\n\n.IK6fT3Qh_foldSummary {\n  cursor: pointer;\n  color: var(--dsw-alias-label-tertiary);\n  user-select: none;\n  align-items: center;\n  gap: 6px;\n  font-size: 12px;\n  font-weight: 500;\n  line-height: 20px;\n  display: flex;\n}\n\n.IK6fT3Qh_foldSummary:before {\n  content: \"\";\n  opacity: .6;\n  border-top: 3px solid #0000;\n  border-bottom: 3px solid #0000;\n  border-left: 4px solid;\n  width: 0;\n  height: 0;\n  transition: transform .12s;\n  transform: translateY(.5px);\n}\n\n.IK6fT3Qh_fold[open] .IK6fT3Qh_foldSummary:before {\n  transform: rotate(90deg);\n}\n\n.IK6fT3Qh_foldSummary:hover {\n  color: var(--dsw-alias-label-secondary);\n}\n\n.IK6fT3Qh_fold[open] .IK6fT3Qh_foldSummary {\n  color: var(--dsw-alias-label-secondary);\n  margin-bottom: 8px;\n}\n\n.IK6fT3Qh_fold .IK6fT3Qh_stepsBlock {\n  background: none;\n  border: none;\n  padding: 4px 0 0;\n}\n";
const tagId$3 = "@lihua_dis/dsh-src/ui-src/FindingsView.module.css";
...
var FindingsView_module_css_default = {
	"fold": "IK6fT3Qh_fold",
	"stepsLabel": "IK6fT3Qh_stepsLabel",
	"steps": "IK6fT3Qh_steps",
	"id": "IK6fT3Qh_id",
	"stepsBlock": "IK6fT3Qh_stepsBlock",
	"list": "IK6fT3Qh_list",
	"header": "IK6fT3Qh_header",
	"title": "IK6fT3Qh_title",
	"description": "IK6fT3Qh_description",
	"asset": "IK6fT3Qh_asset",
	"empty": "IK6fT3Qh_empty",
	"finding": "IK6fT3Qh_finding",
	"foldSummary": "IK6fT3Qh_foldSummary",
	"severity": "IK6fT3Qh_severity"
};
...
function FindingsView({ src, t, runCommand }) {
	...
	const sendReject = async (findingId, reason) => {
		...
		try {
			...
			setFeedback(result.kind === "success" ? `已打回 ${findingId}（理由：${trimmed.slice(0, 60)}${trimmed.length > 60 ? "…" : ""}），等待 agent 处理…` : `命令返回错误：${result.text}`);
			setNoteFor(null);
			setNoteText("");
		} catch (error) {
			setFeedback(`打回失败：${error.message ?? String(error)}`);
		} finally {
			setBusyId(null);
		}
	};
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("ul", {
		...
		children: [findings.map((finding) => {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", {
				...
				children: [
					...
					isRejected && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						style: {
							display: "flex",
							gap: 6,
							padding: "6px 10px",
							...
							background: "rgba(200,90,70,.08)",
							fontSize: 12,
							lineHeight: 1.6,
							overflowWrap: "anywhere"
						},
						"data-testid": "src-finding-rejected",
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: "⚠" }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: "已打回（保留备查，准入闸会拦住相似项二次提交）" }), finding.rejectReason !== "" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							style: {
								marginTop: 2,
								color: "var(--dsw-alias-label-secondary)"
							},
							children: ["打回理由：", finding.rejectReason]
						})] })]
					}),
					...
					(finding.victimImpact ?? "") !== "" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", {
						className: FindingsView_module_css_default.description,
						children: [
							t("finding.victimImpact"),
							": ",
							finding.victimImpact
						]
					}),
					(finding.attackChain ?? "") !== "" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: FindingsView_module_css_default.stepsBlock,
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: FindingsView_module_css_default.stepsLabel,
							children: t("finding.attackChain")
							...
							children: finding.attackChain
						})]
					}),
					finding.discoveryPath !== "" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", {
						className: FindingsView_module_css_default.description,
						children: [
							t("finding.discoveryPath"),
							": ",
							finding.discoveryPath
						]
					}),
					finding.entryPoint !== "" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", {
						className: FindingsView_module_css_default.description,
						children: [
							t("finding.entryPoint"),
							": ",
							finding.entryPoint
						]
					}),
					...
					(finding.rawRequest !== "" || finding.rawResponse !== "") && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("details", {
						className: FindingsView_module_css_default.fold,
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("summary", {
							className: FindingsView_module_css_default.foldSummary,
							children: [
								t("finding.rawRequest"),
								" / ",
								t("finding.rawResponse")
							]
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: FindingsView_module_css_default.stepsBlock,
							children: [finding.rawRequest !== "" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								className: FindingsView_module_css_default.stepsLabel,
								children: t("finding.rawRequest")
							}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("pre", {
								className: FindingsView_module_css_default.steps,
								style: {
									whiteSpace: "pre-wrap",
							...
							})] }), finding.rawResponse !== "" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								className: FindingsView_module_css_default.stepsLabel,
								children: t("finding.rawResponse")
							}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("pre", {
								className: FindingsView_module_css_default.steps,
								style: {
									whiteSpace: "pre-wrap",
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("details", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("summary", {
							className: FindingsView_module_css_default.foldSummary,
							children: t("finding.evidence")
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							className: FindingsView_module_css_default.stepsBlock,
							children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("ol", {
								className: FindingsView_module_css_default.steps,
								children: (finding.pocEvidence ?? []).map((evidence, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("li", { children: evidence }, index))
							})
						})]
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("details", {
					...
					!isRejected && runCommand !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						style: { marginTop: 2 },
						"data-testid": "src-finding-reject",
						children: noteFor?.id === finding.id ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							style: {
								padding: "8px 10px",
								borderRadius: 8,
							...
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									...
									children: "打回此项 —— 说明理由（会转达给 agent，驱动它补 attackChain / 产 PoC）"
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("textarea", {
									...
									onKeyDown: (event) => {
										if (event.key === "Enter" && !event.shiftKey) {
											event.preventDefault();
											sendReject(finding.id, noteText);
										}
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
										...
										style: buttonStyle$1("#c65746"),
										children: busyId !== null ? "发送中…" : "打回"
									}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
										type: "button",
										onClick: () => setNoteFor(null),
										style: buttonStyle$1("var(--dsw-alias-label-tertiary)"),
										children: "取消"
									})]
								})
							]
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								...
								onClick: () => {
									setNoteText("");
									setNoteFor({ id: finding.id });
								},
								style: buttonStyle$1("#c65746"),
								children: "打回"
							}), busyId === finding.id && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								style: {
									color: "#e80",
									fontSize: 12
								},
					...
					feedback !== null && noteFor?.id === finding.id && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						style: {
							color: busyId !== null ? "#e80" : "var(--dsw-alias-state-error-primary, #c33)",
							fontSize: 12,
							padding: "2px 4px"
						},
						children: feedback
		...
		}), feedback !== null && noteFor === null && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("li", {
			style: {
				listStyle: "none",
				color: "var(--dsh-alias-label-secondary)",
				fontSize: 12,
				padding: "4px 2px"
			},
			children: feedback
...
//#endregion
//#region \0dsh-css-module:/Users/lihua-dis/Software/dsh-src/src/dsh-client-ui-src/src/client/AssetsView.module.css.mjs
const css$2 = ".MJh1DlZU_root {\n  flex-direction: column;\n  flex: auto;\n  gap: 10px;\n  min-height: 0;\n  display: flex;\n}\n\n.MJh1DlZU_modeBar {\n  flex: none;\n  gap: 4px;\n  display: flex;\n}\n\n.MJh1DlZU_modeButton {\n  appearance: none;\n  color: var(--dsw-alias-label-tertiary);\n  cursor: pointer;\n  background: none;\n  border: 0;\n  border-radius: 999px;\n  padding: 6px 14px;\n  font-size: 12px;\n  font-weight: 500;\n  line-height: 20px;\n  transition: all .13s;\n}\n\n.MJh1DlZU_modeButton:hover {\n  color: var(--dsw-alias-label-secondary);\n  background: color-mix(in oklab,var(--dsw-alias-bg-layer-2) 60%,transparent);\n}\n\n.MJh1DlZU_modeButton[aria-pressed=\"true\"] {\n  color: var(--dsw-alias-label-primary);\n  background: color-mix(in oklab,var(--dsw-alias-bg-layer-2) 80%,transparent);\n  font-weight: 600;\n  box-shadow: 0 1px 3px #0000000d;\n}\n\n.MJh1DlZU_list {\n  flex-direction: column;\n  flex: auto;\n  gap: 12px;\n  display: flex;\n  overflow-y: auto;\n}\n\n.MJh1DlZU_group {\n  flex-direction: column;\n  gap: 4px;\n  min-width: 0;\n  display: flex;\n}\n\n.MJh1DlZU_groupTitle {\n  color: var(--dsw-alias-label-tertiary);\n  margin: 0;\n  padding-left: 2px;\n  font-size: 12px;\n  font-weight: 600;\n  line-height: 20px;\n}\n\n.MJh1DlZU_rows {\n  flex-direction: column;\n  gap: 4px;\n  margin: 0;\n  padding: 0;\n  list-style: none;\n  display: flex;\n}\n\n.MJh1DlZU_row {\n  border: 1px solid var(--dsw-alias-border-l2);\n  background: var(--dsw-alias-bg-base);\n  border-radius: 8px;\n  align-items: baseline;\n  gap: 8px;\n  min-width: 0;\n  padding: 6px 10px;\n  font-size: 13px;\n  line-height: 20px;\n  display: flex;\n}\n\n.MJh1DlZU_rowValue {\n  color: var(--dsw-alias-label-primary);\n  overflow-wrap: anywhere;\n  font-weight: 500;\n}\n\n.MJh1DlZU_rowMeta {\n  color: var(--dsw-alias-label-tertiary);\n}\n\n.MJh1DlZU_rowParent {\n  color: var(--dsw-alias-label-caption);\n}\n\n.MJh1DlZU_graph {\n  border: 1px solid color-mix(in oklab,var(--dsw-alias-border-l2) 70%,transparent);\n  background: color-mix(in oklab,var(--dsw-alias-bg-base) 75%, transparent);\n  border-radius: 12px;\n  flex: auto;\n  min-height: 320px;\n  position: relative;\n  overflow: hidden;\n}\n\n.MJh1DlZU_graph:before {\n  content: \"\";\n  background: radial-gradient(1200px 800px at 50% 0%, var(--dsw-alias-brand-primary) 1%, transparent 55%), radial-gradient(800px 600px at 100% 100%, var(--dsw-alias-state-business-primary) 0.5%, transparent 45%);\n  opacity: .035;\n  pointer-events: none;\n  z-index: 1;\n  position: absolute;\n  inset: 0;\n}\n\n.MJh1DlZU_graph .react-flow__controls {\n  border: 1px solid var(--dsw-alias-border-l2);\n  box-shadow: none;\n  background: var(--dsw-alias-bg-layer-1);\n  border-radius: 6px;\n  overflow: hidden;\n}\n\n.MJh1DlZU_graph .react-flow__controls-button {\n  border-bottom-color: var(--dsw-alias-border-l2);\n  background: var(--dsw-alias-bg-layer-1);\n  color: var(--dsw-alias-label-secondary);\n}\n\n.MJh1DlZU_graph .react-flow__controls-button:hover {\n  background: var(--dsw-alias-bg-layer-2);\n  color: var(--dsw-alias-label-primary);\n}\n\n.MJh1DlZU_graph .react-flow__controls-button svg {\n  fill: currentColor;\n}\n\n.MJh1DlZU_empty {\n  text-align: center;\n  color: var(--dsw-alias-label-caption);\n  margin: 0;\n  padding: 24px 0;\n  font-size: 13px;\n  line-height: 20px;\n}\n\n.MJh1DlZU_node {\n  box-sizing: border-box;\n  border: 1px solid color-mix(in oklab,var(--dsw-alias-border-l2) 70%,transparent);\n  background: color-mix(in oklab,var(--dsw-alias-bg-layer-1) 68%,transparent);\n  backdrop-filter: blur(4px);\n  cursor: pointer;\n  border-radius: 12px;\n  flex-direction: column;\n  gap: 4px;\n  width: 220px;\n  height: 100px;\n  padding: 10px 12px;\n  font-size: 12px;\n  line-height: 18px;\n  transition: border-color .13s, box-shadow .13s, transform .1s;\n  display: flex;\n  overflow: hidden;\n}\n\n.MJh1DlZU_node:hover {\n  border-color: color-mix(in oklab,var(--dsw-alias-border-l1) 85%,transparent);\n  transform: translateY(-1px);\n  box-shadow: 0 4px 12px -6px #000;\n}\n\n.MJh1DlZU_nodeBadge {\n  background: var(--dsw-alias-bg-layer-2);\n  color: var(--dsw-alias-label-secondary);\n  border-radius: 999px;\n  align-self: flex-start;\n  padding: 0 8px;\n  font-size: 11px;\n  line-height: 18px;\n}\n\n.MJh1DlZU_node[data-type=\"root-domain\"] .MJh1DlZU_nodeBadge {\n  color: var(--dsw-alias-brand-primary);\n  background: var(--dsw-alias-state-business-tertiary);\n}\n\n.MJh1DlZU_node[data-type=\"ip\"] .MJh1DlZU_nodeBadge, .MJh1DlZU_node[data-type=\"service\"] .MJh1DlZU_nodeBadge {\n  color: var(--dsw-alias-state-success-primary);\n  background: var(--dsw-alias-state-success-tertiary);\n}\n\n.MJh1DlZU_nodeValue {\n  min-width: 0;\n  color: var(--dsw-alias-label-primary);\n  text-overflow: ellipsis;\n  white-space: nowrap;\n  font-weight: 600;\n  overflow: hidden;\n}\n\n.MJh1DlZU_nodeMeta {\n  min-width: 0;\n  color: var(--dsw-alias-label-tertiary);\n  -webkit-line-clamp: 2;\n  -webkit-box-orient: vertical;\n  display: -webkit-box;\n  overflow: hidden;\n}\n\n.MJh1DlZU_handle {\n  border: 1px solid var(--dsw-alias-border-l2);\n  background: var(--dsw-alias-bg-layer-2);\n  border-radius: 999px;\n  width: 8px;\n  height: 8px;\n}\n\n.MJh1DlZU_edgeLabel {\n  border: 1px solid var(--dsw-alias-border-l2);\n  background: var(--dsw-alias-bg-layer-2);\n  color: var(--dsw-alias-label-secondary);\n  pointer-events: none;\n  white-space: nowrap;\n  border-radius: 999px;\n  padding: 2px 8px;\n  font-size: 11px;\n  line-height: 16px;\n  position: absolute;\n}\n\n.MJh1DlZU_coverageSummary {\n  color: var(--dsw-alias-label-secondary);\n  flex-wrap: wrap;\n  gap: 4px 14px;\n  margin: 0 0 10px;\n  font-size: 12px;\n  display: flex;\n}\n\n.MJh1DlZU_coverageSummaryItem {\n  white-space: nowrap;\n}\n\n.MJh1DlZU_coverageBadge {\n  white-space: nowrap;\n  vertical-align: 1px;\n  border: 1px solid;\n  border-radius: 999px;\n  margin-left: 6px;\n  padding: 0 6px;\n  font-size: 11px;\n  line-height: 16px;\n  display: inline-block;\n}\n\n.MJh1DlZU_covTested {\n  color: #2e7d32;\n}\n\n.MJh1DlZU_covBlocked {\n  color: #b26a00;\n}\n\n.MJh1DlZU_covNa {\n  color: #6b7280;\n}\n\n.MJh1DlZU_covTesting {\n  color: #1565c0;\n}\n\n.MJh1DlZU_covAssessed {\n  color: var(--dsw-alias-label-secondary);\n}\n\n.MJh1DlZU_covUntouched {\n  color: var(--dsw-alias-label-tertiary, var(--dsw-alias-label-secondary));\n  opacity: .8;\n}\n";
const tagId$2 = "@lihua_dis/dsh-src/ui-src/AssetsView.module.css";
...
var AssetsView_module_css_default = {
	"root": "MJh1DlZU_root",
	"modeBar": "MJh1DlZU_modeBar",
	"node": "MJh1DlZU_node",
	"edgeLabel": "MJh1DlZU_edgeLabel",
	"coverageSummaryItem": "MJh1DlZU_coverageSummaryItem",
	"nodeMeta": "MJh1DlZU_nodeMeta",
	"handle": "MJh1DlZU_handle",
	"modeButton": "MJh1DlZU_modeButton",
	"row": "MJh1DlZU_row",
	"rowMeta": "MJh1DlZU_rowMeta",
	"coverageBadge": "MJh1DlZU_coverageBadge",
	"graph": "MJh1DlZU_graph",
	"covTesting": "MJh1DlZU_covTesting",
	"covAssessed": "MJh1DlZU_covAssessed",
	"covUntouched": "MJh1DlZU_covUntouched",
	"groupTitle": "MJh1DlZU_groupTitle",
	"group": "MJh1DlZU_group",
	"rows": "MJh1DlZU_rows",
	"empty": "MJh1DlZU_empty",
	"list": "MJh1DlZU_list",
	"coverageSummary": "MJh1DlZU_coverageSummary",
	"covTested": "MJh1DlZU_covTested",
	"rowParent": "MJh1DlZU_rowParent",
	"rowValue": "MJh1DlZU_rowValue",
	"nodeBadge": "MJh1DlZU_nodeBadge",
	"covBlocked": "MJh1DlZU_covBlocked",
	"covNa": "MJh1DlZU_covNa",
	"nodeValue": "MJh1DlZU_nodeValue"
};
...
const COVERAGE_CLASSES = {
	tested: AssetsView_module_css_default.covTested,
	blocked: AssetsView_module_css_default.covBlocked,
	notApplicable: AssetsView_module_css_default.covNa,
	testing: AssetsView_module_css_default.covTesting,
	assessed: AssetsView_module_css_default.covAssessed,
	untouched: AssetsView_module_css_default.covUntouched
};
...
function coverageBadgeOfStatus(status) {
...
function hostOfAssetValue(value) {
...
function coverageBadges(src) {
	const explicit = /* @__PURE__ */ new Map();
	for (const row of src.coverage) {
		if (row.assetId === void 0 || row.assetId === "") continue;
...
function AssetList({ src, t }) {
	const rows = (0, react.useMemo)(() => rowsOf(src), [src]);
	const badges = (0, react.useMemo)(() => coverageBadges(src), [src]);
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
			className: AssetsView_module_css_default.coverageSummary,
			"data-testid": "src-assets-coverage-summary",
			children: COVERAGE_ORDER.map((key) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
				className: `${AssetsView_module_css_default.coverageSummaryItem} ${COVERAGE_CLASSES[key]}`,
				children: [
					COVERAGE_LABELS[key],
					" ",
					counts[key]
				...
				children: group.rows.map((row) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", {
					...
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
							...
							style: row.type === "ai-surface" || row.type === "threat-intel" ? {
								color: "#c60",
								fontWeight: 600
							} : void 0,
							children: [
						...
						(() => {
							...
							return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								className: `${AssetsView_module_css_default.coverageBadge} ${COVERAGE_CLASSES[key]}`,
...
//#endregion
//#region \0dsh-css-module:/Users/lihua-dis/Software/dsh-src/src/dsh-client-ui-src/src/client/ReportView.module.css.mjs
const css$1 = ".zHyX28mc_root {\n  flex-direction: column;\n  flex: auto;\n  gap: 10px;\n  min-height: 0;\n  display: flex;\n}\n\n.zHyX28mc_toolbar {\n  justify-content: space-between;\n  align-items: center;\n  gap: 12px;\n  display: flex;\n}\n\n.zHyX28mc_hint {\n  color: var(--dsw-alias-label-tertiary);\n  margin: 0;\n  font-size: 13px;\n  line-height: 20px;\n}\n\n.zHyX28mc_actions {\n  flex: none;\n  gap: 8px;\n  display: flex;\n}\n\n.zHyX28mc_action {\n  appearance: none;\n  border: 1px solid color-mix(in oklab,var(--dsw-alias-border-l1) 80%,transparent);\n  background: color-mix(in oklab,var(--dsw-alias-bg-layer-1) 70%,transparent);\n  backdrop-filter: blur(8px);\n  color: var(--dsw-alias-label-primary);\n  cursor: pointer;\n  border-radius: 999px;\n  padding: 7px 16px;\n  font-size: 13px;\n  font-weight: 500;\n  line-height: 20px;\n  transition: all .16s;\n  box-shadow: 0 1px 2px #00000008, 0 4px 12px -6px #0000000f;\n}\n\n.zHyX28mc_action:hover {\n  border-color: var(--dsw-alias-brand-primary);\n  color: var(--dsw-alias-brand-primary);\n  box-shadow: 0 4px 16px -4px #0000001f, 0 0 0 3px color-mix(in srgb,var(--dsw-alias-brand-primary) 12%,transparent);\n  transform: translateY(-1px);\n}\n\n.zHyX28mc_error {\n  color: var(--dsw-alias-state-error-primary);\n  margin: 0;\n  font-size: 12px;\n  line-height: 18px;\n}\n\n.zHyX28mc_markdown {\n  box-sizing: border-box;\n  border: 1px solid color-mix(in oklab,var(--dsw-alias-border-l2) 70%,transparent);\n  background: color-mix(in oklab,var(--dsw-alias-bg-base) 85%,transparent);\n  backdrop-filter: blur(4px);\n  min-height: 240px;\n  color: var(--dsw-alias-label-secondary);\n  overflow-wrap: anywhere;\n  border-radius: 14px;\n  flex: auto;\n  margin: 0;\n  padding: 20px 24px;\n  font-size: 13.5px;\n  line-height: 22px;\n  overflow: auto;\n}\n\n.zHyX28mc_markdown h1, .zHyX28mc_markdown h2, .zHyX28mc_markdown h3, .zHyX28mc_markdown p {\n  margin: 0;\n}\n\n.zHyX28mc_markdown h1 {\n  border-bottom: 1px solid var(--dsw-alias-border-l2);\n  color: var(--dsw-alias-label-primary);\n  padding-bottom: 10px;\n  font-size: 18px;\n  line-height: 26px;\n}\n\n.zHyX28mc_markdown h2 {\n  color: var(--dsw-alias-label-primary);\n  margin-top: 16px;\n  font-size: 15px;\n  line-height: 24px;\n}\n\n.zHyX28mc_markdown h3 {\n  color: var(--dsw-alias-label-primary);\n  margin-top: 12px;\n  font-size: 14px;\n  line-height: 22px;\n}\n\n.zHyX28mc_bullet {\n  padding-left: 14px;\n}\n\n.zHyX28mc_bullet:before {\n  content: \"•\";\n  color: var(--dsw-alias-label-tertiary);\n  margin-left: -12px;\n  margin-right: 6px;\n}\n\n.zHyX28mc_step {\n  white-space: pre-wrap;\n  padding-left: 28px;\n  font-family: ui-monospace, SFMono-Regular, Menlo, Consolas, monospace;\n  font-size: 12px;\n}\n\n.zHyX28mc_blank {\n  height: 8px;\n}\n\n.zHyX28mc_codeblock {\n  border: 1px solid var(--dsw-alias-border-l2);\n  background: var(--dsw-alias-bg-layer-1);\n  border-radius: 6px;\n  margin: 4px 0;\n  padding: 10px 12px;\n  overflow-x: auto;\n}\n\n.zHyX28mc_codeblock code {\n  color: var(--dsh-alias-label-primary, var(--dsw-alias-label-primary));\n  white-space: pre;\n  overflow-wrap: normal;\n  tab-size: 4;\n  margin: 0;\n  padding: 0;\n  font-family: ui-monospace, SFMono-Regular, Menlo, Consolas, monospace;\n  font-size: 12px;\n  line-height: 18px;\n  display: block;\n}\n\n.zHyX28mc_inlineCode {\n  background: var(--dsw-alias-bg-layer-1);\n  border-radius: 4px;\n  padding: 1px 4px;\n  font-family: ui-monospace, SFMono-Regular, Menlo, Consolas, monospace;\n  font-size: 12px;\n}\n\n.zHyX28mc_tableWrap {\n  margin: 6px 0 10px;\n  overflow-x: auto;\n}\n\n.zHyX28mc_table {\n  border-collapse: collapse;\n  border-collapse: separate;\n  border-spacing: 0;\n  width: 100%;\n  font-size: 12.5px;\n  line-height: 19px;\n}\n\n.zHyX28mc_table th, .zHyX28mc_table td {\n  border-bottom: 1px solid color-mix(in oklab,var(--dsw-alias-border-l2) 70%,transparent);\n  text-align: left;\n  vertical-align: top;\n  padding: 6px 10px;\n}\n\n.zHyX28mc_table th {\n  background: color-mix(in oklab,var(--dsw-alias-bg-layer-1) 55%,transparent);\n  backdrop-filter: blur(4px) saturate(1.1);\n  color: var(--dsw-alias-label-primary);\n  white-space: nowrap;\n  font-weight: 600;\n}\n\n.zHyX28mc_table td {\n  color: var(--dsw-alias-label-secondary);\n}\n\n.zHyX28mc_table tbody tr {\n  transition: background .12s;\n}\n\n.zHyX28mc_table tbody tr:hover {\n  background: color-mix(in oklab,var(--dsw-alias-bg-layer-1) 60%,transparent);\n}\n\n.zHyX28mc_table tbody tr:last-child td {\n  border-bottom-width: 0;\n}\n";
...
var ReportView_module_css_default = {
	"tableWrap": "zHyX28mc_tableWrap",
	"table": "zHyX28mc_table",
	"action": "zHyX28mc_action",
	"markdown": "zHyX28mc_markdown",
	"error": "zHyX28mc_error",
	"toolbar": "zHyX28mc_toolbar",
	"actions": "zHyX28mc_actions",
	"hint": "zHyX28mc_hint",
	"step": "zHyX28mc_step",
	"root": "zHyX28mc_root",
	"bullet": "zHyX28mc_bullet",
	"blank": "zHyX28mc_blank",
	"inlineCode": "zHyX28mc_inlineCode",
	"codeblock": "zHyX28mc_codeblock"
};
...
function researchStatusLabel(t, status) {
...
function coverageStatusLabel(t, status) {
...
function apiSummaryLines(src, t) {
	const stats = src.apiDiscovery ?? {
		total: 0,
		schemas: 0,
		graphql: 0,
		hints: 0,
	...
	const table = mdTable([
		...
		t("report.apiGraphql"),
		t("report.apiHints"),
		t("report.apiUntouched")
	], [[
		String(stats.total),
		String(stats.schemas),
		String(stats.graphql),
		String(stats.hints),
		String(stats.untouched)
	]]);
	const examples = src.assets.filter((asset) => asset.type === "endpoint" && typeof asset.meta === "string" && asset.meta.startsWith("api:")).slice(0, 5).map((asset) => {
...
function coverageTableLines(src, t) {
	...
	return mdTable([
		...
		t("report.colStatus"),
		t("report.colPhase"),
		t("report.colCategory"),
		t("report.colAsset"),
		t("report.colEndpoints"),
		t("report.colLimitation"),
		t("report.colEvidence")
	], rows.map((row) => {
		const skipped = row.endpointsSkipped ?? [];
		const endpoints = row.endpointsTotal === void 0 ? "—" : `${row.endpointsTested ?? 0}/${row.endpointsTotal}${skipped.length > 0 ? `（跳过${skipped.length}）` : ""}`;
		return [
			row.id,
			coverageStatusLabel(t, row.status),
			row.phase,
			row.category,
			row.assetId ?? "—",
			endpoints,
...
function researchTableLines(src, t) {
	...
	return mdTable([
		...
		t("report.colStatus"),
		t("report.colCategory"),
		t("report.colHypothesis"),
		t("report.colStopReason")
	], rows.map((row) => [
		row.id,
		researchStatusLabel(t, row.status),
		row.category,
		row.hypothesis,
...
function aiAssetLines(src, t) {
	const rows = src.assets.filter((asset) => asset.type === "ai-surface" || asset.type === "threat-intel");
	if (rows.length === 0) return [t("report.none")];
	return [
		...rows.map((asset) => `- [${asset.type}] ${asset.value}${asset.meta === "" ? "" : `（${asset.meta}）`}`),
		"",
		t("report.aiAssetsNote")
	];
}
/** ⏸ 等你的事：未完成待办 + 挂起（blocked）且没有对应待办的意图。 */
function waitingOnYouLines(src, t) {
	...
	const blockedIntents = src.nodes.filter((node) => node.kind === "intent" && node.status === "blocked");
...
function reportOf(src, t) {
	...
	const findingSections = activeFindings.flatMap((finding) => {
		...
		const urls = (() => {
			...
			const list = [...found];
			if (list.length === 0) list.push(asset === void 0 ? src.goal?.target ?? "" : asset.value);
			return list.join("; ");
		})();
		const section1 = (() => {
			const lines = [];
		...
		const reproBlock = (() => {
			...
			if ((finding.rawResponse ?? "") !== "") {
				...
				lines.push("=== Response ===", "```", finding.rawResponse, "```");
			}
		...
		const testSource = (() => {
			const factNodes = src.nodes.filter((node) => node.kind === "fact");
			const lines = [];
			for (const evidenceId of finding.concreteLossEvidence ?? []) {
				const fact = factNodes.find((f) => f.id === evidenceId);
				if (fact !== void 0) {
					lines.push(`- ${fact.target === "" ? "" : fact.target + ": "}${fact.detail}`);
					continue;
				}
				const research = (src.research ?? []).find((r) => r.id === evidenceId);
				if (research !== void 0) {
					lines.push(`- [${research.category}] ${research.hypothesis}`);
					continue;
				}
				lines.push(`- ${evidenceId}`);
			}
			if (asset !== void 0) lines.push(`- ${t("finding.affected")}: [${asset.type}] ${asset.value}`);
			return lines.length === 0 ? t("report.none") : lines.join("\n");
		})();
	...
	const checkpointLines = (src.checkpoints ?? []).map((row) => `- ${row.id} [${row.stage}] ${row.intentId} / ${row.childSessionId}: ${row.summary || t("report.noSummary")} (+${row.facts} facts, +${row.assets} assets, +${row.findings} findings)`);
	return [
		`# ${t("report.title")}`,
		"",
...
function blindSpotLines(src, t) {
	const rows = (src.coverage ?? []).filter((row) => row.phase === "blind-spot");
	if (rows.length === 0) return [t("report.blindSpotsEmpty")];
	const statusLabel = (status) => status === "completed" ? t("report.blindSpotCovered") : status === "blocked" ? t("report.blindSpotUncovered") : status === "not-applicable" ? t("report.blindSpotNa") : status;
	return rows.map((row) => {
...
function MarkdownPreview({ markdown }) {
	...
	const renderInline = (text) => {
		...
		while (rest !== "") {
			...
			const next = [code, rest.match(/\*\*([^*]+)\*\*/)].filter((m) => m !== null).sort((a, b) => (a.index ?? 0) - (b.index ?? 0))[0];
			if (next === void 0) {
				parts.push(rest);
				break;
			}
			...
			if (next === code) parts.push(/* @__PURE__ */ (0, react_jsx_runtime.jsx)("code", {
				className: ReportView_module_css_default.inlineCode,
				children: next[1]
			}, i++));
			else parts.push(/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: next[1] }, i++));
			rest = rest.slice(at + next[0].length);
		}
		return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(react_jsx_runtime.Fragment, { children: parts });
	};
	const isTableDelimiter = (line) => /^\|(\s*:?-+:?\s*\|)+$/.test(line.trim());
	const cellsOf = (line) => line.trim().replace(/^\|/, "").replace(/\|$/, "").split("|").map((cell) => cell.trim());
	for (let index = 0; index < lines.length; index += 1) {
		const line = lines[index];
		if (inCode) {
			if (line.trim() === "```") {
				rows.push(/* @__PURE__ */ (0, react_jsx_runtime.jsx)("pre", {
					className: ReportView_module_css_default.codeblock,
					children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("code", { children: codeBuffer.join("\n") })
				}, `code-${codeKey++}`));
				inCode = false;
				codeBuffer = [];
				continue;
		...
		if (line.trim().startsWith("|") && index + 1 < lines.length && isTableDelimiter(lines[index + 1])) {
			...
			while (cursor < lines.length && lines[cursor].trim().startsWith("|")) {
				body.push(cellsOf(lines[cursor]));
				cursor += 1;
			}
			rows.push(/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				className: ReportView_module_css_default.tableWrap,
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("table", {
					className: ReportView_module_css_default.table,
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("tr", { children: header.map((cell, i) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("th", { children: renderInline(cell) }, i)) }) }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("tbody", { children: body.map((row, ri) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("tr", { children: row.map((cell, ci) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("td", { children: renderInline(cell) }, ci)) }, ri)) })]
				})
			}, `table-${tableKey++}`));
			index = cursor - 1;
			continue;
		...
		if (line === "") {
			rows.push(/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { className: ReportView_module_css_default.blank }, `blank-${index}`));
			continue;
		}
		if (line.startsWith("### ")) rows.push(/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h3", { children: renderInline(line.slice(4)) }, index));
		else if (line.startsWith("## ")) rows.push(/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h2", { children: renderInline(line.slice(3)) }, index));
		else if (line.startsWith("# ")) rows.push(/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h1", { children: renderInline(line.slice(2)) }, index));
		...
		else rows.push(/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", { children: renderInline(line) }, `p-${paraKey++}`));
	}
	if (inCode && codeBuffer.length > 0) rows.push(/* @__PURE__ */ (0, react_jsx_runtime.jsx)("pre", {
		className: ReportView_module_css_default.codeblock,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("code", { children: codeBuffer.join("\n") })
	}, `code-${codeKey++}`));
...
//#endregion
//#region \0dsh-css-module:/Users/lihua-dis/Software/dsh-src/src/dsh-client-ui-src/src/client/SrcView.module.css.mjs
const css = ".x_JDqK3a_root {\n  box-sizing: border-box;\n  background: linear-gradient(180deg,color-mix(in srgb,var(--dsw-alias-bg-base) 80%,transparent) 0%,transparent 400px);\n  flex-direction: column;\n  gap: 16px;\n  height: 100%;\n  padding: 20px 24px 32px;\n  display: flex;\n  overflow-y: auto;\n}\n\n.x_JDqK3a_card {\n  background: color-mix(in oklab,var(--dsw-alias-bg-layer-1) 70%,transparent);\n  backdrop-filter: blur(28px) saturate(1.4);\n  border: 1px solid color-mix(in oklab,var(--dsw-alias-border-l1) 55%,transparent);\n  min-width: 0;\n  box-shadow: 0 1px 3px #0000000a,0 4px 16px -6px #0000000f,0 12px 32px -12px #00000014,0 0 0 1px var(--dsw-alias-border-l1);\n  border-radius: 20px;\n  flex-direction: column;\n  flex: none;\n  gap: 10px;\n  padding: 20px 24px;\n  transition: box-shadow .2s, border-color .2s;\n  display: flex;\n}\n\n.x_JDqK3a_card:hover {\n  box-shadow: 0 2px 6px #0000000d,0 12px 24px -8px #00000014,0 24px 48px -24px #0000001a,0 0 0 1px var(--dsw-alias-border-l1);\n  box-shadow: 0 2px 6px #00000014;\n}\n\n.x_JDqK3a_cardTitle {\n  align-items: baseline;\n  gap: 14px;\n  min-width: 0;\n  display: flex;\n}\n\n.x_JDqK3a_target {\n  color: var(--dsw-alias-label-primary);\n  overflow-wrap: anywhere;\n  letter-spacing: -.02em;\n  flex: none;\n  margin: 0;\n  font-size: 22px;\n  font-weight: 700;\n  line-height: 30px;\n}\n\n.x_JDqK3a_objective {\n  min-width: 0;\n  color: var(--dsw-alias-label-secondary);\n  overflow-wrap: anywhere;\n  flex: auto;\n  font-size: 13px;\n  line-height: 24px;\n}\n\n.x_JDqK3a_counts {\n  color: var(--dsw-alias-label-tertiary);\n  margin: 0;\n  font-size: 13px;\n  line-height: 20px;\n}\n\n.x_JDqK3a_authorization {\n  color: var(--dsw-alias-label-secondary);\n  overflow-wrap: anywhere;\n  margin: 0;\n  font-size: 13px;\n  line-height: 20px;\n}\n\n.x_JDqK3a_tabs {\n  border-bottom: 1px solid var(--dsw-alias-border-l1);\n  flex: none;\n  gap: 2px;\n  display: flex;\n  position: relative;\n}\n\n.x_JDqK3a_tab {\n  appearance: none;\n  color: var(--dsw-alias-label-tertiary);\n  cursor: pointer;\n  background: none;\n  border: 0;\n  border-radius: 12px 12px 0 0;\n  padding: 8px 16px;\n  font-size: 13px;\n  font-weight: 500;\n  line-height: 22px;\n  transition: color .15s, background .15s;\n  position: relative;\n}\n\n.x_JDqK3a_tab:after {\n  content: \"\";\n  background: var(--dsw-alias-brand-primary);\n  opacity: 0;\n  border-radius: 2px 2px 0 0;\n  height: 2px;\n  transition: opacity .18s, transform .2s cubic-bezier(.4, 0, .2, 1);\n  position: absolute;\n  bottom: -1px;\n  left: 14px;\n  right: 14px;\n  transform: scaleX(.9);\n}\n\n.x_JDqK3a_tab:hover {\n  color: var(--dsw-alias-label-secondary);\n  background: color-mix(in oklab,var(--dsw-alias-bg-layer-2) 35%,transparent);\n}\n\n.x_JDqK3a_tab[aria-pressed=\"true\"] {\n  color: var(--dsw-alias-label-primary);\n  background: linear-gradient(in oklab longer hue,var(--dsw-alias-bg-layer-2),transparent 40%);\n  font-weight: 650;\n}\n\n.x_JDqK3a_tab[aria-pressed=\"true\"]:after {\n  opacity: 1;\n  transform: scaleX(1);\n}\n\n.x_JDqK3a_content {\n  flex-direction: column;\n  flex: auto;\n  min-height: 0;\n  display: flex;\n}\n\n.x_JDqK3a_empty {\n  box-sizing: border-box;\n  place-items: center;\n  height: 100%;\n  padding: 24px;\n  display: grid;\n}\n\n.x_JDqK3a_emptyText {\n  text-align: center;\n  max-width: 480px;\n  color: var(--dsw-alias-label-tertiary);\n  font-size: 13px;\n  line-height: 22px;\n}\n\n.x_JDqK3a_headRow {\n  flex-wrap: wrap;\n  align-items: flex-start;\n  gap: 12px;\n  display: flex;\n}\n\n.x_JDqK3a_statTrack {\n  background: color-mix(in oklab,var(--dsw-alias-bg-layer-1) 55%,transparent);\n  backdrop-filter: blur(12px) saturate(1.25);\n  border: 1px solid color-mix(in oklab,var(--dsw-alias-border-l1) 50%,transparent);\n  border-radius: 16px;\n  flex: none;\n  gap: 3px;\n  padding: 6px;\n  display: flex;\n  box-shadow: 0 1px 2px #00000005, inset 0 0 0 1px #ffffff0f;\n}\n\n.x_JDqK3a_stat {\n  text-align: center;\n  border-radius: 12px;\n  min-width: 68px;\n  padding: 8px 14px;\n  transition: background .13s, color .13s, transform .12s;\n}\n\n.x_JDqK3a_stat:hover {\n  background: color-mix(in oklab,var(--dsw-alias-bg-layer-2) 70%,transparent);\n  transform: translateY(-1px);\n  box-shadow: 0 2px 6px #0000000d;\n}\n\n.x_JDqK3a_statValue {\n  color: var(--dsw-alias-label-primary);\n  font-variant-numeric: tabular-nums;\n  font-feature-settings: \"tnum\" 1;\n  font-size: 15px;\n  font-weight: 600;\n  line-height: 20px;\n  transition: color .16s ease-out;\n}\n\n.x_JDqK3a_statLabel {\n  color: var(--dsw-alias-label-tertiary);\n  margin-top: 1px;\n  font-size: 11px;\n  line-height: 14px;\n}\n\n.x_JDqK3a_statAccent .x_JDqK3a_statValue {\n  color: var(--dsw-alias-state-error-primary);\n}\n\n.x_JDqK3a_statWarn .x_JDqK3a_statValue {\n  color: var(--dsw-alias-state-warn-primary);\n}\n\n.x_JDqK3a_statMuted .x_JDqK3a_statValue {\n  color: var(--dsw-alias-label-tertiary);\n  font-weight: 500;\n}\n\n.x_JDqK3a_metaRow {\n  flex-wrap: wrap;\n  align-items: center;\n  gap: 8px;\n  display: flex;\n}\n\n.x_JDqK3a_badge {\n  color: var(--dsw-alias-label-secondary);\n  background: var(--dsw-alias-bg-layer-1);\n  border: 1px solid var(--dsw-alias-border-l1);\n  overflow-wrap: anywhere;\n  border-radius: 999px;\n  max-width: 100%;\n  padding: 2px 10px;\n  font-size: 11px;\n  line-height: 18px;\n}\n\n.x_JDqK3a_tabBadge {\n  color: var(--dsw-alias-brand-primary);\n  background: color-mix(in srgb,var(--dsw-alias-brand-primary) 10%,transparent);\n  font-variant-numeric: tabular-nums;\n  letter-spacing: .02em;\n  border: 1px solid color-mix(in srgb,var(--dsw-alias-brand-primary) 20%,transparent);\n  border-radius: 999px;\n  margin-left: 8px;\n  padding: 1px 8px;\n  font-size: 10.5px;\n  font-weight: 650;\n  line-height: 16px;\n}\n\n.x_JDqK3a_tab[aria-pressed=\"true\"] .x_JDqK3a_tabBadge {\n  color: var(--dsw-alias-brand-primary);\n  background: color-mix(in srgb,var(--dsw-alias-brand-primary) 12%,transparent);\n}\n\n.x_JDqK3a_tabBadgeHot {\n  color: #fff;\n  background: var(--dsw-alias-state-error-primary, #c65746);\n  box-shadow: 0 0 0 2px #c657462e;\n}\n\n.x_JDqK3a_groupHead {\n  justify-content: space-between;\n  align-items: center;\n  display: flex;\n}\n\n.x_JDqK3a_groupTitle {\n  color: var(--dsw-alias-label-primary);\n  font-size: 13px;\n  font-weight: 600;\n  line-height: 20px;\n}\n\n.x_JDqK3a_fieldRow {\n  align-items: center;\n  gap: 8px;\n  display: flex;\n}\n\n.x_JDqK3a_fieldLabel {\n  width: 96px;\n  color: var(--dsw-alias-label-secondary);\n  flex-shrink: 0;\n  font-size: 12px;\n}\n";
...
var SrcView_module_css_default = {
	"counts": "x_JDqK3a_counts",
	"empty": "x_JDqK3a_empty",
	"target": "x_JDqK3a_target",
	"groupTitle": "x_JDqK3a_groupTitle",
	"fieldLabel": "x_JDqK3a_fieldLabel",
	"statValue": "x_JDqK3a_statValue",
	"statAccent": "x_JDqK3a_statAccent",
	"statTrack": "x_JDqK3a_statTrack",
	"cardTitle": "x_JDqK3a_cardTitle",
	"root": "x_JDqK3a_root",
	"tabs": "x_JDqK3a_tabs",
	"emptyText": "x_JDqK3a_emptyText",
	"stat": "x_JDqK3a_stat",
	"statLabel": "x_JDqK3a_statLabel",
	"metaRow": "x_JDqK3a_metaRow",
	"badge": "x_JDqK3a_badge",
	"card": "x_JDqK3a_card",
	"tabBadgeHot": "x_JDqK3a_tabBadgeHot",
	"tab": "x_JDqK3a_tab",
	"content": "x_JDqK3a_content",
	"headRow": "x_JDqK3a_headRow",
	"statMuted": "x_JDqK3a_statMuted",
	"authorization": "x_JDqK3a_authorization",
	"groupHead": "x_JDqK3a_groupHead",
	"fieldRow": "x_JDqK3a_fieldRow",
	"statWarn": "x_JDqK3a_statWarn",
	"objective": "x_JDqK3a_objective",
	"tabBadge": "x_JDqK3a_tabBadge"
};
...
function TodoListView({ src, t, runCommand }) {
	...
	if (todos.length === 0) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		className: SrcView_module_css_default.empty,
		children: "暂无用户待办（需要登录态/Burp 协助等人工事项会出现在这里）"
	});
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		className: SrcView_module_css_default.list,
		children: [feedback !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
			style: {
				color: busyId !== null ? "var(--dsw-alias-state-warn-primary, #e80)" : "var(--dsw-alias-state-error-primary, #c33)",
				fontSize: 12,
				padding: "2px 4px"
			},
			children: feedback
		}), todos.map((todo) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			className: SrcView_module_css_default.card,
			style: {
				borderLeft: `3px solid ${todo.status === "done" ? "var(--dsw-alias-state-success-primary, #3c9)" : todo.status === "abandoned" ? "var(--dsw-alias-label-tertiary, #999)" : "var(--dsw-alias-state-warn-primary, #e80)"}`,
				marginBottom: 4,
				padding: "6px 10px",
				fontSize: 13
			},
			children: [
				/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						style: {
							color: "var(--dsw-alias-label-caption, #aaa)",
							marginLeft: 6,
							fontSize: 11
						},
						children: todo.id
				...
				todo.note !== "" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					style: { color: "var(--dsw-alias-state-success-primary, #3c9)" },
					children: ["用户备注：", todo.note]
				}),
				todo.status === "pending" && runCommand !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					style: { marginTop: 4 },
					children: noteFor?.id === todo.id ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(react_jsx_runtime.Fragment, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						style: {
							marginTop: 6,
							padding: "8px 10px",
							borderRadius: 8,
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								...
								children: noteFor.status === "done" ? "✓ 标记为已完成 —— 补充备注（可选，会转达给 AI）" : "✗ 放弃此项 —— 说明原因（可选，会转达给 AI）"
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("textarea", {
								autoFocus: true,
								rows: 3,
								value: noteText,
								placeholder: noteFor.status === "done" ? "如：已用 Burp 抓好登录包\n（Enter 发送，Shift+Enter 换行）" : "如：暂不测短信，跳过这项\n（Enter 发送，Shift+Enter 换行）",
								onChange: (event) => setNoteText(event.target.value),
								onKeyDown: (event) => {
									if (event.key === "Enter" && !event.shiftKey) {
										event.preventDefault();
										sendTodoFeedback(todo.id, noteFor.status, noteText);
									}
									if (event.key === "Escape") setNoteFor(null);
								},
								style: {
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									type: "button",
									disabled: busyId !== null,
									onClick: () => void sendTodoFeedback(todo.id, noteFor.status, noteText),
									style: buttonStyle(noteFor.status === "done" ? "var(--dsw-alias-state-success-primary, #3c9)" : "var(--dsw-alias-label-tertiary, #999)"),
									children: busyId !== null ? "发送中…" : "发送"
								}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									type: "button",
									onClick: () => setNoteFor(null),
									style: buttonStyle("var(--dsw-alias-label-tertiary, #888)"),
									children: "取消"
								})]
							})
						]
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								...
								style: buttonStyle("var(--dsw-alias-state-success-primary, #3c9)"),
								children: "✓ 我已完成"
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								type: "button",
								...
								style: buttonStyle("var(--dsw-alias-label-tertiary, #999)"),
								children: "✗ 放弃此项"
							}),
							busyId === todo.id && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								style: {
									color: "var(--dsw-alias-state-warn-primary, #e80)",
									fontSize: 12
								},
								children: "发送中…"
							})
...
function ApprovalListView({ src, t, runCommand }) {
	const [busyId, setBusyId] = (0, react.useState)(null);
	const [feedback, setFeedback] = (0, react.useState)(null);
	const [noteFor, setNoteFor] = (0, react.useState)(null);
	const [noteText, setNoteText] = (0, react.useState)("");
	const approvals = (Array.isArray(src.pendingApprovals) ? src.pendingApprovals : []).slice().sort((a, b) => {
		const rank = (row) => row.status === "pending" ? 0 : row.status === "approved" ? 1 : 2;
		return rank(a) - rank(b) || (b.createdAt ?? 0) - (a.createdAt ?? 0);
	});
	if (approvals.length === 0) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		className: SrcView_module_css_default.empty,
		children: "暂无待审请求（高危删改/越权请求、资产归属确认会挂在这里等你决定）"
	});
	const sendApproval = async (id, action, note = "") => {
		if (busyId !== null || runCommand === void 0) return;
		setBusyId(id);
		setFeedback(null);
		setNoteFor(null);
		...
		try {
			...
			const isAssetRow = approvals.find((row) => row.id === id)?.method === "ASSET";
			setFeedback(result.kind === "success" ? isAssetRow ? `${id} 已处理：${action === "allow" ? "确认归属，整域已纳入授权" : "已否决，整域已排除"}${trimmed === "" ? "" : `（备注：${trimmed.slice(0, 60)}）`}` : `已转达 ${id} → ${action === "allow" ? "批准" : "拒绝"}${trimmed === "" ? "" : `（备注：${trimmed.slice(0, 60)}）`}，等待 agent 发出/丢弃…` : `命令返回错误：${result.text}`);
		} catch (error) {
			setFeedback(`发送失败：${error?.message ?? String(error)}`);
		} finally {
			setBusyId(null);
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [feedback !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
			...
			children: feedback
		}), approvals.map((ap) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			className: SrcView_module_css_default.card,
			style: {
				borderLeft: `3px solid ${ap.status === "approved" ? "var(--dsw-alias-state-success-primary, #3c9)" : ap.status === "rejected" ? "var(--dsw-alias-label-tertiary, #999)" : "var(--dsw-alias-state-error-primary, #c33)"}`,
				marginBottom: 4,
				padding: "6px 10px",
				fontSize: 13
			},
			children: [
				/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [
					ap.method === "ASSET" ? "🏷️" : "⚠️",
					" ",
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: ap.method === "ASSET" ? `资产归属确认：${ap.url}` : `${ap.method} ${ap.url}` }),
					" ",
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
				...
				ap.status !== "pending" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					style: {
						color: ap.status === "approved" ? "var(--dsw-alias-state-success-primary, #3c9)" : "var(--dsw-alias-label-tertiary, #999)",
						fontSize: 12
					},
					children: [ap.status === "approved" ? ap.method === "ASSET" ? "已确认归属（整域授权）" : `已批准${ap.responseStatus > 0 ? ` → 响应 ${ap.responseStatus}` : ""}` : ap.method === "ASSET" ? "已否决（整域排除）" : "已拒绝", ap.note !== "" ? `· 备注：${ap.note}` : ""]
				}),
				ap.justification !== "" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					style: { color: "var(--dsw-alias-label-tertiary, #888)" },
					children: ap.justification
				}),
				ap.reason !== "" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					style: {
						color: "var(--dsw-alias-label-tertiary, #888)",
						fontSize: 12
					},
					children: [ap.method === "ASSET" ? "判定依据：" : "分类理由：", ap.reason]
				}),
				ap.method !== "ASSET" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("details", {
					style: { marginTop: 2 },
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("summary", {
						style: {
							cursor: "pointer",
				...
				ap.status === "pending" && runCommand !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					style: { marginTop: 4 },
					children: noteFor?.id === ap.id ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(react_jsx_runtime.Fragment, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						style: {
							marginTop: 6,
							padding: "8px 10px",
							borderRadius: 8,
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								...
								children: noteFor.action === "allow" ? ap.method === "ASSET" ? "确认归属——补充备注（可选）" : "批准——补充备注（可选，会转达给 AI）" : ap.method === "ASSET" ? "否决——说明原因（可选）" : "拒绝——说明原因（可选，会转达给 AI）"
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("textarea", {
								autoFocus: true,
								rows: 3,
								value: noteText,
								placeholder: noteFor.action === "allow" ? ap.method === "ASSET" ? "如：确实是目标公司的注册域\n（Enter 发送，Shift+Enter 换行）" : "如：可信测试账号、是自己的资源\n（Enter 发送，Shift+Enter 换行）" : "如：不批准，可能误伤真实用户\n（Enter 发送，Shift+Enter 换行）",
								onChange: (event) => setNoteText(event.target.value),
								onKeyDown: (event) => {
									if (event.key === "Enter" && !event.shiftKey) {
										event.preventDefault();
										sendApproval(ap.id, noteFor.action, noteText);
									}
									if (event.key === "Escape") setNoteFor(null);
								},
								style: {
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									type: "button",
									disabled: busyId !== null,
									onClick: () => void sendApproval(ap.id, noteFor.action, noteText),
									style: buttonStyle(noteFor.action === "allow" ? "var(--dsw-alias-state-success-primary, #3c9)" : "var(--dsw-alias-label-tertiary, #999)"),
									children: busyId !== null ? "发送中…" : "发送"
								}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									type: "button",
									onClick: () => setNoteFor(null),
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								...
								style: buttonStyle("var(--dsw-alias-state-success-primary, #3c9)"),
								children: ap.method === "ASSET" ? "✓ 确认归属" : "✓ 批准"
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								type: "button",
								disabled: busyId !== null,
								...
								style: buttonStyle("var(--dsw-alias-label-tertiary, #999)"),
								children: ap.method === "ASSET" ? "✗ 非本组织" : "✗ 拒绝"
							}),
							busyId === ap.id && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								style: {
									color: "var(--dsw-alias-state-warn-primary, #e80)",
									fontSize: 12
								},
...
function TimelineDetail({ event }) {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [timelineDetailRow("状态", e.status), timelineDetailRow("详情", e.detail)] });
}
function TimelineView({ src, t }) {
	...
	const intentStatusMark = (status) => status === "completed" ? "✓" : status === "blocked" ? "✗" : status === "failed" ? "!" : status === "deprecated" ? "⊘" : "·";
	const factEvents = factNodes.map((f) => ({
		kind: "fact",
		id: f.id,
		parent: f.intentId,
		factKind: f.factKind,
		...
		at: f.createdAt ?? 0,
		short: `[事实][${f.factKind}] ${(f.detail ?? "").slice(0, 80)}`
	}));
	const findingEvents = findingRows.map((f) => ({
		...f,
		kind: "finding",
		id: f.id,
		parent: f.intentId,
		allAssets: assets,
		at: f.createdAt ?? 0,
		short: `[漏洞][${f.severity}] ${f.title}`
	}));
	const intentEvents = (src.nodes ?? []).filter((node) => node.kind === "intent").map((i) => ({
		kind: "intent",
		id: i.id,
		parent: null,
		title: i.title,
		...
		status: i.status,
		at: i.createdAt ?? 0,
		short: `[意图] ${intentStatusMark(i.status)} ${i.title}${i.priority ? ` [P${i.priority}]` : ""}`
	}));
	const ckEvents = checkpoints.map((c) => ({
		kind: "checkpoint",
		id: c.id,
		parent: c.intentId,
		stage: c.stage,
		...
		at: c.createdAt,
		short: `[检查点][${c.stage}] +${c.facts}f/+${c.assets}a/+${c.findings}v · ${(c.summary || "").slice(0, 60)}${(c.summary ?? "").length > 60 ? "…" : ""}`
	}));
	const obsEvents = (Array.isArray(src.observations) ? src.observations : []).map((o) => ({
		kind: "observation",
		id: o.id,
		parent: o.intentId,
		method: o.method,
		...
		protectionSignal: !!o.protectionSignal,
		wafBypassed: !!o.wafBypassed,
		source: o.source,
		decision: o.decision ?? "",
		assetId: o.assetId,
		respHeaders: o.respHeaders ?? "",
		respBodySnippet: o.respBodySnippet ?? "",
		at: o.createdAt,
		short: `[探测] ${o.method} ${o.path} → ${o.httpStatus}${o.protectionSignal ? " ⛔WAF" : ""}${o.wafBypassed ? " ✂已绕过" : ""}`
	}));
	const events = [
		...intentEvents,
		...factEvents,
	...
	if (events.length === 0) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		className: SrcView_module_css_default.empty,
		children: t("timeline.empty")
	});
	const filtered = filter === "all" ? events : events.filter((e) => e.kind === filter);
	const color = (k) => k === "finding" ? "var(--dsw-alias-state-error-primary, #d33)" : k === "fact" ? "var(--dsw-alias-state-info-primary, #39c)" : k === "checkpoint" ? "var(--dsw-alias-label-tertiary, #999)" : k === "observation" ? "var(--dsw-alias-state-warn-primary, #e80)" : "var(--dsw-alias-state-success-primary, #3c9)";
	const fmtTime = (at) => at > 0 ? new Date(at).toLocaleTimeString([], {
		hour12: false,
		hour: "2-digit",
		minute: "2-digit"
	}) : "--:--";
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
			...
			children: chips.map(([key, label]) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
				type: "button",
				...
				style: {
					...
					padding: "1px 10px",
					borderRadius: 999,
					border: `1px solid ${color(key === "all" ? "var(--dsw-alias-label-tertiary, #888)" : key)}`,
					background: filter === key ? "rgba(127,127,127,.18)" : "transparent",
					color: "inherit"
				},
				children: label
			}))
			...
			children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				children: filtered.map((e) => {
					...
					return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						style: {
							...
							marginBottom: 2,
							fontSize: 12,
							background: selectedKey === key || selected === e ? "rgba(127,127,127,.16)" : "transparent"
						},
						"data-testid": "src-timeline-item",
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								style: {
									color: color(e.kind),
				...
				"data-testid": "src-timeline-detail",
				children: selected === null ? t("timeline.empty") : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						style: {
							fontWeight: 600,
							marginBottom: 4
...
function InfraView({ src, t, runCommand }) {
	...
	const [feedback, setFeedback] = (0, react.useState)(null);
	if (runCommand === void 0) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		className: SrcView_module_css_default.empty,
		children: "当前会话不支持命令回传，无法在此修改基础设施设置。"
	});
	...
	const row_proxyUrl = /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		className: SrcView_module_css_default.fieldRow,
		children: [
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("label", {
				className: SrcView_module_css_default.fieldLabel,
				title: "留空=全直连。仅 google/github 等无法直连的境外站点自动走代理，国内目标一律直连",
				children: "HTTP 代理"
			}),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
				value: draft.proxyUrl ?? resolved.proxyUrl ?? "",
				...
				onKeyDown: (event) => {
					if (event.key === "Enter") save("proxyUrl", draft.proxyUrl ?? "");
				},
				style: {
					flex: 1,
					minWidth: 120,
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
				...
				onClick: () => void save("proxyUrl", draft.proxyUrl ?? ""),
				style: buttonStyle("var(--dsw-alias-state-success-primary, #3c9)"),
				children: busyKey === "proxyUrl" ? "保存中…" : "保存"
			})
		]
	});
	const row_httpTimeoutMs = /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		className: SrcView_module_css_default.fieldRow,
		children: [
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("label", {
				className: SrcView_module_css_default.fieldLabel,
				title: "单请求超时毫秒（1000..60000），留空用默认 8000",
				children: "HTTP 超时(ms)"
			}),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
				value: draft.httpTimeoutMs ?? resolved.httpTimeoutMs ?? "",
				placeholder: "8000",
				title: "单请求超时毫秒（1000..60000），留空用默认 8000",
				onChange: (event) => setDraft((prev) => ({
					...prev,
					httpTimeoutMs: event.target.value
				})),
				onKeyDown: (event) => {
					if (event.key === "Enter") save("httpTimeoutMs", draft.httpTimeoutMs ?? "");
				},
				style: {
					flex: 1,
					minWidth: 120,
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
				type: "button",
				disabled: busyKey !== null,
				onClick: () => void save("httpTimeoutMs", draft.httpTimeoutMs ?? ""),
				style: buttonStyle("var(--dsw-alias-state-success-primary, #3c9)"),
				children: busyKey === "httpTimeoutMs" ? "保存中…" : "保存"
			})
		]
	});
	const row_burpMcpPort = /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		className: SrcView_module_css_default.fieldRow,
		children: [
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("label", {
				className: SrcView_module_css_default.fieldLabel,
				title: "Burp Pro「MCP Server」扩展的监听端口，默认 9876。默认端口下面板配置即全部；改非 9876 端口需同步在接线块 env 设 BURP_SSE_URL 并重启（见 README）",
				children: "Burp 监听端口"
			}),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
				value: draft.burpMcpPort ?? resolved.burpMcpPort ?? "",
				placeholder: "9876",
				title: "Burp Pro「MCP Server」扩展的监听端口，默认 9876。默认端口下面板配置即全部；改非 9876 端口需同步在接线块 env 设 BURP_SSE_URL 并重启（见 README）",
				onChange: (event) => setDraft((prev) => ({
					...prev,
					burpMcpPort: event.target.value
				})),
				onKeyDown: (event) => {
					if (event.key === "Enter") save("burpMcpPort", draft.burpMcpPort ?? "");
				},
				style: {
					flex: 1,
					minWidth: 120,
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
				type: "button",
				disabled: busyKey !== null,
				onClick: () => void save("burpMcpPort", draft.burpMcpPort ?? ""),
				style: buttonStyle("var(--dsw-alias-state-success-primary, #3c9)"),
				children: busyKey === "burpMcpPort" ? "保存中…" : "保存"
			})
		]
	});
	const row_testAccount = /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		className: SrcView_module_css_default.fieldRow,
		children: [
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("label", {
				className: SrcView_module_css_default.fieldLabel,
				title: "越权 A/B 对照测试账号凭据；登录不了时 agent 会转用户待办",
				children: "对照账号"
			}),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
				value: draft.testAccount ?? resolved.testAccount ?? "",
				placeholder: "user:pass 或用户名",
				title: "越权 A/B 对照测试账号凭据；登录不了时 agent 会转用户待办",
				onChange: (event) => setDraft((prev) => ({
					...prev,
					testAccount: event.target.value
				})),
				onKeyDown: (event) => {
					if (event.key === "Enter") save("testAccount", draft.testAccount ?? "");
				},
				style: {
					flex: 1,
					minWidth: 120,
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
				type: "button",
				disabled: busyKey !== null,
				onClick: () => void save("testAccount", draft.testAccount ?? ""),
				style: buttonStyle("var(--dsw-alias-state-success-primary, #3c9)"),
				children: busyKey === "testAccount" ? "保存中…" : "保存"
			})
		]
	});
	const row_testPhone = /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		className: SrcView_module_css_default.fieldRow,
		children: [
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("label", {
				className: SrcView_module_css_default.fieldLabel,
				title: "短信/验证码类测试用，多个逗号分隔；仅限授权测试",
				children: "测试手机号"
			}),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
				value: draft.testPhone ?? resolved.testPhone ?? "",
				...
				onKeyDown: (event) => {
					if (event.key === "Enter") save("testPhone", draft.testPhone ?? "");
				},
				style: {
					flex: 1,
					minWidth: 120,
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
				type: "button",
				disabled: busyKey !== null,
				onClick: () => void save("testPhone", draft.testPhone ?? ""),
				style: buttonStyle("var(--dsw-alias-state-success-primary, #3c9)"),
				children: busyKey === "testPhone" ? "保存中…" : "保存"
			})
		]
	});
	const row_burpPath = /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		className: SrcView_module_css_default.fieldRow,
		children: [
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("label", {
				className: SrcView_module_css_default.fieldLabel,
				title: "Burp MCP 自定义桥脚本绝对路径。一般留空=包 patch 默认桥 ~/.dsh/tools/burp-mcp-bridge.mjs（caps-sync 自动安装）",
				children: "自定义桥路径"
			}),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
				value: draft.burpProxyJarPath ?? resolved.burpProxyJarPath ?? "",
				placeholder: "~/.dsh/tools/burp-mcp-bridge.mjs（留空=默认）",
				title: "仅供 agent 参考与接线记录；实际接线在 profile patch，改后重启 dsh web 生效",
				onChange: (event) => setDraft((prev) => ({
					...prev,
					burpProxyJarPath: event.target.value
				})),
				onKeyDown: (event) => {
					if (event.key === "Enter") save("burpProxyJarPath", draft.burpProxyJarPath ?? "");
				},
				style: {
					flex: 1,
					minWidth: 120,
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
				type: "button",
				disabled: busyKey !== null,
				onClick: () => void save("burpProxyJarPath", draft.burpProxyJarPath ?? ""),
				style: buttonStyle("var(--dsw-alias-state-success-primary, #3c9)"),
				children: busyKey === "burpProxyJarPath" ? "保存中…" : "保存"
			})
		]
	});
	const bridgeSnippet = [
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [
			feedback !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				style: {
					color: busyKey !== null ? "var(--dsw-alias-state-warn-primary)" : "var(--dsw-alias-state-success-primary)",
					fontSize: 12,
					padding: "2px 4px"
				},
				children: feedback
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
					type: "button",
					disabled: copyingInfra || busyKey !== null,
					title: "把最近配置过的其他会话的设置复制到本会话并覆盖当前值；新会话建目标（src_add_goal）时已自动沿用，此按钮用于重新复制或覆盖当前值",
					onClick: () => void sendTool("/src-infra-copy", setCopyingInfra, "沿用中…"),
					style: buttonStyle("var(--dsw-alias-state-success-primary, #3c9)"),
					children: copyingInfra ? "沿用中…" : "沿用上次会话的基础设施"
				}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					style: {
						color: "var(--dsw-alias-label-tertiary)",
						fontSize: 11
					},
					children: "新会话建目标时自动沿用，免逐项重填"
				})]
			}),
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: SrcView_module_css_default.card,
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: SrcView_module_css_default.groupHead,
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: SrcView_module_css_default.groupTitle,
							children: "网络出站"
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							type: "button",
							disabled: proxyTesting || busyKey !== null,
							title: "服务端直接经代理请求探针地址，结果只显示在这里，不打扰 agent",
							onClick: () => void sendTool("/src-proxy-test", setProxyTesting, "测活中…"),
							style: buttonStyle("var(--dsw-alias-state-info-primary, #69c)"),
							children: proxyTesting ? "测活中…" : "测试代理连通"
						})]
					}),
					row_proxyUrl,
					row_httpTimeoutMs
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							...
							type: "button",
							disabled: burpTesting || busyKey !== null,
							title: "先经自愈桥 tools_list，再真实拉一条 proxy history 验证完整链路",
							onClick: () => void sendTool("/src-burp-test", setBurpTesting, "发送中…"),
							style: buttonStyle("var(--dsw-alias-state-info-primary, #69c)"),
							children: burpTesting ? "测试中…" : "测试连接"
						})]
					}),
					row_burpMcpPort,
					row_burpPath,
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						children: "前置：Burp Pro 装「MCP Server」扩展并点 Start。接线开箱即用（包 patch 默认启用）；桥未装时跑一次 caps-sync 即自动安装"
					})
				]
			}),
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
		...
		children: [
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("header", {
				className: SrcView_module_css_default.card,
				children: [
					src.goal !== null && src.goal.objective !== "" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", {
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						}), src.goal !== null && src.goal.authorization !== "" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
					...
					(() => {
						...
						const authBudgetAccent = authBudget === void 0 || authBudget.used === 0 ? SrcView_module_css_default.statMuted : authBudget.used >= authBudget.limit ? SrcView_module_css_default.statAccent : authBudget.used * 5 >= authBudget.limit * 4 ? SrcView_module_css_default.statWarn : "";
						const stats = [
							[
								"意图",
								src.counts.intents,
							...
							[
								"漏洞",
								src.counts.findings,
								src.counts.findings > 0 ? SrcView_module_css_default.statAccent : ""
							],
							[
								"检查点",
								src.counts.checkpoints ?? 0,
								(src.counts.checkpoints ?? 0) === 0 ? SrcView_module_css_default.statMuted : ""
							],
							[
								"探测",
								src.counts.observations ?? 0,
								(src.counts.observations ?? 0) === 0 ? SrcView_module_css_default.statMuted : ""
							],
							[
								"待办",
								pendingTodos,
								pendingTodos > 0 ? SrcView_module_css_default.statAccent : SrcView_module_css_default.statMuted
							],
							[
								"待审",
								pendingApprovals,
								pendingApprovals > 0 ? SrcView_module_css_default.statAccent : SrcView_module_css_default.statMuted
							],
							[
								"认证",
								authBudget === void 0 ? "—" : `${authBudget.used}/${authBudget.limit}`,
								authBudgetAccent
							]
						];
						return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							className: SrcView_module_css_default.statTrack,
							children: stats.map(([label, value, accent]) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								className: `${SrcView_module_css_default.stat} ${accent}`,
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									className: SrcView_module_css_default.statValue,
									children: value
								}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									className: SrcView_module_css_default.statLabel,
									children: label
								})]
							}))
						});
					...
					src.apiDiscovery && (src.apiDiscovery.total ?? 0) > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", {
						...
						children: [
							"API 发现：",
							src.apiDiscovery.total ?? 0,
							" · schema ",
							src.apiDiscovery.schemas ?? 0,
							" · GraphQL ",
							src.apiDiscovery.graphql ?? 0,
							" · hint ",
							src.apiDiscovery.hints ?? 0,
							" · 未推进 ",
							src.apiDiscovery.untouched ?? 0
						]
					})
				]
			}),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("nav", {
				...
				children: TABS.map((tabKey) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					...
					children: [t(TAB_LABELS[tabKey]), (() => {
						...
						if (n === 0) return null;
						return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: `${SrcView_module_css_default.tabBadge} ${tabKey === "todos" ? SrcView_module_css_default.tabBadgeHot : ""}`,
							children: n
						});
					})()]
				}))
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				children: (() => {
					switch (tab) {
						case "explore": return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ExploreView, {
							src,
							t
						});
						case "findings": return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(FindingsView, {
							src,
							t,
							runCommand
						});
						case "assets": return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(AssetsView, {
							src,
							t
						});
						case "timeline": return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TimelineView, {
							src,
							t
						});
						case "todos": return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(react.Fragment, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							style: {
								display: "flex",
								gap: 12,
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									...
									children: "待办事项"
								}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TodoListView, {
									src,
									t,
									runCommand
								})]
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									...
									children: "⚠️ 高危请求待审"
								}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ApprovalListView, {
									src,
									t,
									runCommand
								})]
						...
						case "infra": return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(InfraView, {
							src,
							t,
							runCommand
						});
						case "report": return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ReportView, {
							src,
							t
						});
						default: return null;
...
*/
function apply(ctx) {
	ctx.effect(() => ctx.locale.register("src", {
		zh,
		en
	}), "ui-src: dictionaries");
	const t = ctx.locale.bind("src");
	...
	ctx.slots.inject("conversation.view", () => {
		...
		const sync = () => {
			...
			disposeEntry = ctx.slots.register({
				...
				locale: "src",
				label: () => t("view.src"),
				inject: (sessionId) => ({ runCommand: async (line) => {

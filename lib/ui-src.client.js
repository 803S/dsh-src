window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const tagId$6 = "@lihua_dis/dsh-src/ui-src/raw";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId$6) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "@lihua_dis/dsh-src/ui-src";
		...
		*/
		...
		const tagId$5 = "@lihua_dis/dsh-src/ui-src/GraphDetailDrawer.module.css";
		...
		const tagId$4 = "@lihua_dis/dsh-src/ui-src/AssetsView.module.css";
		...
		*/
		...
		const tagId$3 = "@lihua_dis/dsh-src/ui-src/ExploreView.module.css";
		...
		*/
		...
		const tagId$2 = "@lihua_dis/dsh-src/ui-src/FindingsView.module.css";
		...
		const tagId$1 = "@lihua_dis/dsh-src/ui-src/ReportView.module.css";
		...
		const tagId = "@lihua_dis/dsh-src/ui-src/SrcView.module.css";
		...
		*/
		...
		function InfraView({ src, t, runCommand }) {
			...
			const row_burpMcpPort = /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { className: SrcView_module_css_default.fieldRow, children: [
				(0, react_jsx_runtime.jsx)("label", { className: SrcView_module_css_default.fieldLabel, title: "Burp Pro「MCP Server」扩展的监听端口，默认 9876。默认端口下面板配置即全部；改非 9876 端口需同步在接线块 env 设 BURP_SSE_URL 并重启（见 README）", children: "Burp 监听端口" }),
			...
			const row_burpPath = /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { className: SrcView_module_css_default.fieldRow, children: [
				(0, react_jsx_runtime.jsx)("label", { className: SrcView_module_css_default.fieldLabel, title: "Burp MCP 自定义桥脚本绝对路径。一般留空=包 patch 默认桥 ~/.dsh/tools/burp-mcp-bridge.mjs（caps-sync 自动安装）", children: "自定义桥路径" }),
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { className: SrcView_module_css_default.list, children: [
				...
				/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { className: SrcView_module_css_default.card, children: [
					...
					row_burpMcpPort,
				row_burpPath,
					(0, react_jsx_runtime.jsx)("div", { style: { color: "var(--dsw-alias-label-tertiary)", fontSize: 11 }, children: "前置：Burp Pro 装「MCP Server」扩展并点 Start。接线开箱即用（包 patch 默认启用）；桥未装时跑一次 caps-sync 即自动安装" })
				] }),
				/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { className: SrcView_module_css_default.card, children: [

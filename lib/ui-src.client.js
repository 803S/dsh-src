...
function reportOf(src, t) {
	...
	const findingSections = activeFindings.flatMap((finding) => {
		...
		const appDownload = (() => {
			...
			const m = String(asset.meta ?? "").match(/(https?:\/\/[^\s'"]+)/);
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				children: (() => {
					switch (tab) {
						...
						case "todos": return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TodoListView, {
							src,
							t,
							runCommand
						});
...
const en = {
	...
	"report.name": "Vulnerability/Intel name",
	"report.vulnType": "Vulnerability/Intel type",
	"report.severity": "Severity",
	"report.url": "Vulnerability/Intel URL",

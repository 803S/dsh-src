	...
	factory: (require) => {
		...
		*/
		...
		function TodoListView({ src, t }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { className: SrcView_module_css_default.list, children: todos.map((todo) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { className: SrcView_module_css_default.card, style: { borderLeft: `3px solid ${todo.status === "done" ? "#3c9" : todo.status === "abandoned" ? "#999" : "#e80"}`, marginBottom: 4, padding: "6px 10px", fontSize: 13 }, children: [
		...
		function TimelineView({ src, t }) {
			...
			const obsEvents = observations.map((o) => ({ kind: "observation", id: o.id, parent: o.intentId, label: `${o.method} ${o.path} -> ${o.httpStatus}${o.protectionSignal ? " (WAF/403/429)" : ""}${o.wafBypassed ? " (bypassed)" : ""} [${o.source}]${o.decision ? " · " + o.decision : ""}`, at: o.createdAt }));
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { className: SrcView_module_css_default.list, children: events.map((e) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { className: SrcView_module_css_default.card, style: { borderLeft: `3px solid ${color(e.kind)}`, marginBottom: 4, padding: "6px 10px", fontSize: 13 }, children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("strong", { children: [e.kind, " · ", e.id] }), e.parent && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { style: { color: "#888", marginLeft: 8 }, children: `↦ ${e.parent}` }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { children: e.label })] }, `${e.kind}-${e.id}`)) });
		}
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						tab === "todos" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TodoListView, { src, t }),

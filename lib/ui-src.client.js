				...
				todos.map((todo) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { className: SrcView_module_css_default.card, style: { borderLeft: `3px solid ${todo.status === "done" ? "#3c9" : todo.status === "abandoned" ? "#999" : "#e80"}`, marginBottom: 4, padding: "6px 10px", fontSize: 13 }, children: [
					...
					todo.status === "pending" && runCommand !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { style: { marginTop: 4 }, children: [
						noteFor?.id === todo.id ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(react_jsx_runtime.Fragment, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { style: { marginTop: 6, padding: "8px 10px", borderRadius: 8, border: "1px solid rgba(127,127,127,.3)", background: "var(--dsw-alias-bg-layer-2, rgba(127,127,127,.08))" }, children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", { autoFocus: true, value: noteText, placeholder: noteFor.status === "done" ? "如：已用 Burp 抓好登录包" : "如：暂不测短信，跳过这项", onChange: (event) => setNoteText(event.target.value), onKeyDown: (event) => { if (event.key === "Enter") void sendTodoFeedback(todo.id, noteFor.status, noteText); if (event.key === "Escape") setNoteFor(null); }, style: { display: "block", width: "100%", boxSizing: "border-box", fontSize: 13, padding: "6px 10px", borderRadius: 6, border: "1px solid rgba(127,127,127,.4)", background: "transparent", color: "inherit" } }),
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { className: SrcView_module_css_default.list, children: [
				...
				/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { style: { marginTop: 10, fontSize: 12, padding: "8px 10px", borderRadius: 8, border: "1px solid rgba(127,127,127,.3)", background: "var(--dsw-alias-bg-layer-2, rgba(127,127,127,.08))" }, children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("ol", { style: { margin: "0 0 6px", paddingLeft: 18, lineHeight: 1.7 }, children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("li", { children: "点下方按钮让 agent 实测一次连接并汇报结果。" })
					] }),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", { type: "button", disabled: burpTesting || busyKey !== null, onClick: async () => {
						...
						try {
							...
							setFeedback(result.kind === "success" ? "测试请求已发出，agent 的实测结果会出现在对话里。" : `命令返回错误：${result.text}`);
						} catch (error) {
							setFeedback(`发送失败：${error?.message ?? String(error)}`);
						} finally {
